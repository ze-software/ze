...
A hundred independent peer decisions can produce two distinct bodies. Ze compares the completed changes before rebuilding, then copies matching output into each peer's own buffer.
