...
A malformed BGP attribute is a small example of why I spend so much time on proof, even when the implementation is already written and its tests are green.
