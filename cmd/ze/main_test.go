...
func TestAvailablePlugins(t *testing.T) {
	...
	expected := []string{"bgp-adj-rib-in", "bgp-evpn", "bgp-flowspec", "bgp-gr", "bgp-hostname", "bgp-labeled", "bgp-llnh", "bgp-ls", "bgp-mup", "bgp-mvpn", "bgp-persist", "bgp-rib", "bgp-route-refresh", "bgp-rs", "bgp-rtc", "bgp-softver", "bgp-vpls", "bgp-vpn", "bgp-watchdog", "role"}
