...
func TestAvailablePlugins(t *testing.T) {
	...
	expected := []string{"bgp-evpn", "bgp-flowspec", "bgp-gr", "bgp-hostname", "bgp-labeled", "bgp-llnh", "bgp-ls", "bgp-mup", "bgp-mvpn", "bgp-rib", "bgp-rr", "bgp-rtc", "bgp-softver", "bgp-vpls", "bgp-vpn", "role"}
