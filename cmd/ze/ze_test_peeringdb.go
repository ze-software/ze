...
func zeTestPeeringdbCmd(args []string) int {
...
`)
	...
	mux.HandleFunc("/api/net", zeTestHandlePeeringDBNet)
...
func zeTestHandlePeeringDBNet(w http.ResponseWriter, r *http.Request) {
	...
	b.Str(`{"data":[{"asn":`)
	b.Uint(asn)
	b.Str(`,"info_prefixes4":`)
	b.Uint(ipv4)
	b.Str(`,"info_prefixes6":`)
	b.Uint(ipv6)
	b.Str(`,"irr_as_set":"`)
	b.Str(irrASSet)
	b.Str(`"}]}`)
