...
func printRIBPipeline() {
	...
	fmt.Println()
	fmt.Println("  bgp rib show [scope] [filters...] [terminal]")
	fmt.Println("  bgp rib show best [filters...] [terminal]")
	fmt.Println()
	...
	fmt.Println("    bgp rib show received family ipv4/unicast")
	fmt.Println("    bgp rib show sent prefix 10.0 count")
	fmt.Println("    bgp rib show received community 65000:100 path ^64501")
	fmt.Println("    bgp rib show best family ipv4/unicast json")
	fmt.Println()
}
...
func printRecipes() {
	...
	fmt.Println("    ze cli -c \"bgp rib show received family ipv4/unicast\"")
	fmt.Println("    ze cli -c \"bgp rib show best\"")
	fmt.Println()
