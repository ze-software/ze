...
// Usage:
//
//	CGO_ENABLED=0 go run scripts/codegen/web_assets.go          write the per-page import sets
//	CGO_ENABLED=0 go run scripts/codegen/web_assets.go --check  fail when they are stale
//	CGO_ENABLED=0 go run scripts/codegen/web_assets.go --json   print the derived sets, write nothing
//
