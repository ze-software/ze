...
const (
	bubblesCursorPatchPath = "scripts/dev/patches/bubbles-textinput-cursor.patch"
	bubblesCursorRecovery  = "git apply scripts/dev/patches/bubbles-textinput-cursor.patch"
)
