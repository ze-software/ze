...
Found on 2026-07-30 during phase 2b of `plan/spec-rfcgate-1b-rfc7296-pilot.md`. An agent
...
`plan/spec-rfcgate-1b-rfc7296-pilot.md` owns rows `RFC7296-2.8-1` and `RFC7296-2.8.2-1`.
