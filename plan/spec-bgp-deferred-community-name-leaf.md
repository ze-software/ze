...
Deferred by spec-followup-bgp-feature item 4.

community-name web decorator leaf wiring (decorator registered in service_web.go and functional; no community leaf exists in the BGP YANG to attach it to)
