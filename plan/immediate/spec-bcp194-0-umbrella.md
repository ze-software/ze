...
| Spec | Scope | Owns |
|------|-------|------|
| `plan/immediate/spec-bcp194-1-communities.md` | RFC 7454 §11 and all of RFC 8195 | C1 to C7, L1, L2 |
| `plan/immediate/spec-bcp194-2-role-policy.md` | role-derived policy | P4, P5, P6, P9 |
| `plan/immediate/spec-bcp194-3-session.md` | RFC 7454 §4 and §5 | S1, S2 |
| `plan/immediate/spec-bcp194-4-prefix.md` | RFC 7454 §6.1 and §8 | P1, P2, P3, P8 |
...
- `plan/immediate/spec-bcp194-1-communities.md` through `plan/spec-bcp194-5-damping.md` -
  status transitions as each child starts

## Files to Create

- the retired deferral shard "bcp194-0-umbrella" - created when the first row is deferred
