...
| 3 | `plan/spec-dataplane-seams-3-route-egress-interface.md` | research first, may cancel | `plan/immediate/spec-fib-depth.md` (in-progress) |
...
### Related Specs
- [ ] `plan/immediate/spec-fib-depth.md` - in-progress, owns FIB programming depth; child 3 lands in its territory
...
- [ ] `plan/immediate/spec-lifecycle-invariants.md` - ready, written by the same cross-cutting review method
...
- the retired deferral shard "dataplane-seams" - on the first deferral
