...
to the retired deferral shard "cli-pipe-operator-coverage".
...
|----------------|--------------|-------------------------|
| none | done | the retired deferral shard "cli-pipe-operator-coverage" contains no data row and is removed with the spec in Commit B |
