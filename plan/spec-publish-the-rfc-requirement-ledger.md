...
| 7 | Requirements | Two rows per requirement: the anchored id and its quoted sentence spanning the table, then the level, the section's own title and the tests. The tests are a grid, one row per citation, tier before the name, with a row for an absent polarity and the annotation reason beneath. No Note column | AC-2, AC-12, AC-21, AC-25, AC-53, AC-55, AC-56, AC-57, AC-58, AC-59, AC-60 |
