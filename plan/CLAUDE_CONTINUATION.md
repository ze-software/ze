...
**Config system complete.** Next priorities:
- `plan/api-commit-batching.md` - Route batching with commit start/end
- `plan/config-routes-eor.md` - EOR after config routes
