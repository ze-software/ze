...
| Who else touches this path? | `plan/spec-rfcgate-1b-rfc7296-pilot.md` (active, IPsec tags), plus sibling sessions in `internal/component/ike/**` and `internal/component/bgp/**`. This spec touches neither tree. |
...
| 9 | RFC behavior implemented, changed, or newly proven? | No | no requirement changes status here. This spec makes a tier AVAILABLE; binding a requirement to it is `plan/spec-rfcgate-1b-rfc7296-pilot.md` |
