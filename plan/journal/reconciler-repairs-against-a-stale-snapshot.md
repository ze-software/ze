...
|------|------|---------|---------|-----|
| 2026-09-10 | spec-ipsec-dataplane-inspection | CLI, health, and metric drift comparisons | A kernel dump from before rekey was compared with Child SA belief from after rekey, producing false drift. | `ObserveDataplane` detects publications and overlapping backend writes across the observation; inconsistent results are unknown. |
