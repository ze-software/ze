...
|------|------|---------|---------|-----|
| 2026-09-10 | spec-ipsec-dataplane-inspection | `policyKey` and `policyInfoFromKernel` | An explicit full-tunnel prefix and its implicit wildcard produced different owner keys. Readback therefore lost the owner of an installed policy. | Normalize implicit prefixes to the writer-selected family and retain explicit prefix families. |
