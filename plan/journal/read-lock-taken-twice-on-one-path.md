...
|------|------|---------|---------|-----|
| 2026-09-17 | storage-1-backend-parity | Storage guarded listing, reached by editor rename | `guardedList` held the store mutex while calling an accessor that acquired it again. Editor rename stopped. | Read through the already-locked encoding. Shared conformance and actual CLI/web rename pass. |
