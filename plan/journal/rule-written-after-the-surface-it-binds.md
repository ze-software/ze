...
| 2026-09-22 | - | Canonical RFC audit, summary and implementation skills | The RFC and completion rules used baseline-first scope, but the skills still required automatic full implementation or treated agreed boundaries as void. | Replaced the conflicting instructions with the agreed capability boundary, explicit gap records and separate feature scope. Regenerated the skill copies. |
