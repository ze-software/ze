...
6. `plan/learned/339-gr-receiving-speaker.md` — GR plugin pattern (model for RPKI plugin)
...
- [ ] `plan/learned/339-gr-receiving-speaker.md` — GR plugin coordination pattern
