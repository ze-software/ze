...
|------|---------|---------|-----------|--------|--------|
| 2026-08-22 | 1d9dec9c | ipsec: prove a responder-role rekey against strongSwan (+13 more) | ./le verify current mode full (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
| 2026-08-22 | 1d9dec9c | ipsec: prove a responder-role rekey against strongSwan (+3 more) | full ./le verify current mode full over this commit's Go | no full ./le verify current mode full recorded (tmp/ze-verify-full.json is missing) | open |
