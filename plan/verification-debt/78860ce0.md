...
|------|---------|---------|-----------|--------|--------|
| 2026-08-22 | 78860ce0 | fix(verify-worktree): keep a red run's stage logs past the worktree (+5 more) | ./le verify current mode full (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | cleared |
