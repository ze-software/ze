...
| 2026-08-30 | bae6e1b4 | fix(hooks): close the option that hid every banned git verb | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=1, at 2026-08-29T14:01:28Z) | open |
| 2026-08-30 | bae6e1b4 | fix(hooks): close the option that hid every banned git verb | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
| 2026-08-30 | bae6e1b4 | fix(hooks): close the option that hid every banned git verb | discovery-index freshness | ran ./le discovery-index update over this tree and it produced no diff, so ai/PACKAGE-MAP.md is already current for these files | open |
| 2026-08-30 | bae6e1b4 | fix(ike): drop a tag from a test that cannot fail for it | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=1, at 2026-08-29T14:01:28Z) | open |
| 2026-08-30 | bae6e1b4 | fix(ike): drop a tag from a test that cannot fail for it | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
| 2026-08-30 | bae6e1b4 | fix(ike): drop a tag from a test that cannot fail for it | discovery-index freshness | ran ./le discovery-index update over this tree and it produced no diff | open |
| 2026-08-30 | bae6e1b4 | fix(rfc): three public support claims that name the wrong RFC | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=1, at 2026-08-29T14:01:28Z) | open |
| 2026-08-30 | bae6e1b4 | fix(rfc): three public support claims that name the wrong RFC | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
| 2026-08-30 | bae6e1b4 | fix(rfc): three public support claims that name the wrong RFC | discovery-index freshness | ran ./le discovery-index update over this tree and it produced no diff | open |
