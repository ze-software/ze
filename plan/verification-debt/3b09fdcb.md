...
| 2026-09-01 | 3b09fdcb | test(bmp): pin the post-policy-only scope decision | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
| 2026-09-01 | 3b09fdcb | test(bmp): pin the post-policy-only scope decision | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
