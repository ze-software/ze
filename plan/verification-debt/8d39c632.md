...
|------|---------|---------|-----------|--------|--------|
| 2026-08-24 | 8d39c632 | feat(demos): record terminal demos as asciicasts and drop VHS (+1 more) | ./le verify current mode full (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
