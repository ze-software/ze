...
|------|---------|---------|-----------|--------|--------|
| 2026-08-24 | 8d39c632 | feat(demos): record terminal demos as asciicasts and drop VHS | ze-precommit-verify (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
| 2026-08-24 | 8d39c632 | feat(demos): record terminal demos as asciicasts and drop VHS | full ze-precommit-verify over this commit's Go | no full ze-precommit-verify recorded (tmp/ze-verify-full.json is missing) | open |
| 2026-08-24 | 8d39c632 | plan: close spec-website-asciinema-terminal-demos | ze-precommit-verify (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
