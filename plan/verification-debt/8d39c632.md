...
|------|---------|---------|-----------|--------|--------|
| 2026-08-24 | 8d39c632 | feat(demos): record terminal demos as asciicasts and drop VHS (+1 more) | ./le verify current mode full (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | cleared |
| 2026-08-24 | 8d39c632 | feat(demos): record terminal demos as asciicasts and drop VHS | full ./le verify current mode full over this commit's Go | no full ./le verify current mode full recorded (tmp/ze-verify-full.json is missing) | cleared |
