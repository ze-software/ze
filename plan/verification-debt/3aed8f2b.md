...
|------|---------|---------|-----------|--------|--------|
| 2026-09-05 | 3aed8f2b | close spec-traceroute-source-af (+1 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=130, at 2026-09-05T17:25:15Z) | cleared |
| 2026-09-05 | 3aed8f2b | close spec-traceroute-source-af | full native verification over this commit's Go | no full native verification covers this commit's Go | cleared |
