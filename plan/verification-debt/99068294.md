...
|------|---------|---------|-----------|--------|--------|
| 2026-08-21 | 99068294 | fix(verify-worktree): prune with --expire now so no entry survives | ze-precommit-verify (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
| 2026-08-21 | 99068294 | rules(git-safety): add a Worktree Cleanup section | ze-precommit-verify (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
