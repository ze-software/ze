...
|------|---------|---------|-----------|--------|--------|
| 2026-09-07 | 5e2d7854 | isis: cite RFC 1195 for the level-agnostic point-to-point IIH (+42 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=130, at 2026-09-05T17:25:15Z) | open |
| 2026-09-07 | 5e2d7854 | isis: cite RFC 1195 for the level-agnostic point-to-point IIH (+13 more) | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
