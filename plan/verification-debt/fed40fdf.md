...
|------|---------|---------|-----------|--------|--------|
| 2026-09-02 | fed40fdf | fix(deps): take grpc 1.83.1 for the HTTP/2 DATA frame OOM (+1 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
