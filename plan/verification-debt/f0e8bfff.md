...
|------|---------|---------|-----------|--------|--------|
| 2026-09-05 | f0e8bfff | spec(anomaly): close the anomaly-observe incident lifecycle store (+1 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
