...
|------|---------|---------|-----------|--------|--------|
| 2026-09-12 | c9bdcd62 | feat(le): le publishes the command surface it declares (+1 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=1, at 2026-09-11T10:56:02Z) | open |
...
| 2026-09-12 | c9bdcd62 | feat(le): le publishes the command surface it declares (+1 more) | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
