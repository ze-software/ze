...
| 2026-08-20 | 71801542 | journal: a full disk red the gate twice, on a device df did not name | ze-precommit-verify structural gates (red) | the structural reds in the record are the staticcheck matrix and tracked-build failing to write the build cache on a full device, not a broken tree | cleared |
