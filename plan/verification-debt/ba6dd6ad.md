...
| 2026-09-04 | ba6dd6ad | journal: three web goldens agree with a schema missing bgp | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
| 2026-09-04 | ba6dd6ad | journal: three web goldens agree with a schema missing bgp | discovery-index freshness | the only PACKAGE-MAP row that moved is another session's; this commit adds and removes no package | open |
