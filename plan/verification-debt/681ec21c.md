...
|------|---------|---------|-----------|--------|--------|
| 2026-08-20 | 681ec21c | plan: three specs for record answers as the only encoding | ./le verify current mode full (not FRESH-green) | plan and deferral markdown only, no source, test, or build input in the commit: ./le verify current mode full has nothing to observe about it | cleared |
