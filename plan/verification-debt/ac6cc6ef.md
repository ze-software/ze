...
|------|---------|---------|-----------|--------|--------|
| 2026-09-06 | ac6cc6ef | feat(firewall): close domain-group, and say why a cache entry is missing (+1 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=130, at 2026-09-05T17:25:15Z) | open |
