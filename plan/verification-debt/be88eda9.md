...
| 2026-09-04 | be88eda9 | test(sysrib): publishDistances reaches the seam producers read | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
| 2026-09-04 | be88eda9 | test(sysrib): publishDistances reaches the seam producers read | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
