...
|------|---------|---------|-----------|--------|--------|
| 2026-09-04 | be88eda9 | fix(rib): one declaration of distance, read where it decides (+6 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | cleared |
| 2026-09-04 | be88eda9 | fix(rib): one declaration of distance, read where it decides (+5 more) | full native verification over this commit's Go | no full native verification covers this commit's Go | cleared |
