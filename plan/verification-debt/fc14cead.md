...
|------|---------|---------|-----------|--------|--------|
| 2026-09-08 | fc14cead | blog: clarify articles and add revision history (+1 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=130, at 2026-09-05T17:25:15Z) | open |
