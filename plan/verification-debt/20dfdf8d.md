...
|------|---------|---------|-----------|--------|--------|
| 2026-09-09 | 20dfdf8d | blog: restore personal narratives and original arguments (+10 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=1, at 2026-09-05T00:11:54Z) | open |
...
| 2026-09-12 | 20dfdf8d | docs: make README a concise project entry point (+1 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=1, at 2026-09-11T10:56:02Z) | open |
| 2026-09-12 | 20dfdf8d | docs: make README a concise project entry point | native structural checks (red) | README-only change cannot affect tier/check or iface-resolution. Existing unattributed structural reds are outside this documentation scope. | open |
| 2026-09-12 | 20dfdf8d | docs: record launcher reuse of a target binary on the host | native structural checks (red) | Journal-only change cannot affect the existing unattributed tier/check and iface-resolution failures. | open |
