...
|------|---------|---------|-----------|--------|--------|
| 2026-09-09 | 20dfdf8d | blog: restore personal narratives and original arguments (+5 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=1, at 2026-09-05T00:11:54Z) | open |
| 2026-09-10 | 20dfdf8d | fix(ospf): publish deferred auto-cost changes and join origination (+2 more) | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
