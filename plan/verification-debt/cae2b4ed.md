...
| 2026-08-19 | cae2b4ed | docs(journal): close the RawJSON row the owner decided | ze-precommit-verify structural gates (red) | the reds are another session's mid-edit internal/plugins/flowspec-firewall/bridge_test.go typecheck and internal/component/ssh/ssh.go gofmt; this commit edits one markdown row and can affect neither | cleared |
