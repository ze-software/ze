...
|------|---------|---------|-----------|--------|--------|
| 2026-08-22 | a0e45b98 | fix(commit-helper): a refused subject names its overage (+15 more) | ./le verify current mode full (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | cleared |
