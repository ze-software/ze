...
| 2026-08-31 | af1dcb16 | plan: close spec-fixit-peer-pending-sync-settles-too-early (+11 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
| 2026-08-31 | af1dcb16 | fix(interop): run the two checkers that never left their guard (+6 more) | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
