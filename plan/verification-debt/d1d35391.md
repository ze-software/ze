...
|------|---------|---------|-----------|--------|--------|
| 2026-08-24 | d1d35391 | chore(debt): record the verification-debt rows a clear pass cleared (+35 more) | ./le verify current mode full (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
| 2026-08-24 | d1d35391 | docs(bgp): record two consumer defects and correct a section citation (+10 more) | full ./le verify current mode full over this commit's Go | no full ./le verify current mode full recorded (tmp/ze-verify-full.json is missing) | open |
