...
|------|---------|---------|-----------|--------|--------|
| 2026-08-24 | 10f00630 | fix(ste): stop the prose gate flagging a name and a column (+7 more) | ./le verify current mode full (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | cleared |
| 2026-08-24 | 10f00630 | docs: rewrite the comments the STE gate flagged (+4 more) | full ./le verify current mode full over this commit's Go | no full ./le verify current mode full recorded (tmp/ze-verify-full.json is missing) | cleared |
