...
| 2026-08-19 | f8bfdd86 | feat(commit-helper): arm the test-coverage gate behind --no-test (+1 more) | ./le verify current mode full (not FRESH-green) | owner ordered the commit; a full verify is mid-run in this checkout and has not rewritten the record | open |
