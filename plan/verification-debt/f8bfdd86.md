...
|------|---------|---------|-----------|--------|--------|
| 2026-08-19 | f8bfdd86 | fix(hooks): the test-first gate blocks, and earns a commit-time half | ./le verify current mode full (not FRESH-green) | owner ordered commit with no checks; hook suite green this session (parity 206/206, fixtures 562/562) | cleared |
...
| 2026-08-19 | f8bfdd86 | fix(commit-helper): record_debt appends a row the shard already owes | ./le verify current mode full (not FRESH-green) | owner ordered the previous commit with no checks and this follows it; commit_helper 226/226, parity 206/206, fixtures 562/562 green this session | cleared |
...
| 2026-08-19 | f8bfdd86 | feat(commit-helper): arm the test-coverage gate behind --no-test (+1 more) | ./le verify current mode full (not FRESH-green) | owner ordered the commit; a full verify is mid-run in this checkout and has not rewritten the record | cleared |
