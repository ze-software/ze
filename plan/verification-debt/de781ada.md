...
|------|---------|---------|-----------|--------|--------|
| 2026-09-06 | de781ada | fix(iface): refuse a tunnel ttl the vpp backend cannot carry (+2 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: last verify failed (exit=130, at 2026-09-05T17:25:15Z) | open |
