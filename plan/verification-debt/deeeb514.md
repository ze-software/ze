...
|------|---------|---------|-----------|--------|--------|
| 2026-09-02 | deeeb514 | feat(cli): Tab reveals what a command is and what it does (+4 more) | full native verification (not FRESH-green) | verify-status is not FRESH-green: STALE: no status file (never verified) | open |
| 2026-09-02 | deeeb514 | feat(cli): Tab reveals what a command is and what it does (+3 more) | full native verification over this commit's Go | no full native verification covers this commit's Go | open |
