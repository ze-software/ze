...
| Who else touches this path? | `plan/spec-fixit-send-community-suppress-ignored.md` (egress community suppression), `plan/spec-fixit-rs-community-strip-arity.md` (strip arity on this exact rail), `plan/spec-fixit-otc-src-role-meta-fallback.md` (role resolution), `plan/spec-fixit-dynamic-group-peer-config.md` (dynamic peers get no plugin config) |
