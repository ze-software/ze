...
- **NAMING COLLISION, flagged:** "A-4" means two different things. In `1098` and in
  `doctor.go` / `lcp.go` ("see A-4"), it is the ORIGIN spec's A-4 = the BGP-netns
