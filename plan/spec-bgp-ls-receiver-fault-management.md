...
| Depends | - |
| Phase | - |
| Deferral shard | `plan/deferrals/bgp-ls-receiver-fault-management.md` |
| Handoff | - |
| Updated | 2026-08-26 |
...
| Who else touches this path? | `rfc7606.go` is shared by every family's validation; `plan/spec-bgp-ls-origination-and-the-scheduled-marker.md` touches the same ls plugin from the encode side |
