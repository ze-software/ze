...
- the retired deferral shard "qemu-targets-boot-the-shipped-kernel" <!-- doc-links: ignore (nothing was deferred, so this shard was never created) --> - nothing deferred, so not created
