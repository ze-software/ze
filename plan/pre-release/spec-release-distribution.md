...
3. `plan/pre-release/spec-release-evidence-gate.md` and `plan/pre-release/spec-release-audit-0-umbrella.md`.
...
- [ ] `plan/pre-release/spec-release-evidence-gate.md` - full release-readiness evidence matrix.
...
- [ ] `plan/pre-release/spec-release-audit-0-umbrella.md` - first user-facing release audit.
...
- [ ] `plan/pre-release/spec-release-audit-8-docs-onboarding.md` - release-facing documentation audit.
...
- [ ] `internal/component/cli/sshclient/client.go,385-423` - local super-admin uses the stored bcrypt hash as an opaque SSH token.
...
- [ ] Commit B removes only `plan/pre-release/spec-release-distribution.md` after Commit A is preserved.
