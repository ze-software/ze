...
3. `plan/pre-release/spec-release-audit-1-surface-inventory.md` - release surface inventory and evidence matrix
...
- [ ] `plan/pre-release/spec-release-audit-0-umbrella.md` - release audit method and finding schema
...
- [ ] `plan/pre-release/spec-release-audit-1-surface-inventory.md` - BGP rows in release surface matrix
...
- `plan/pre-release/spec-release-audit-2-bgp-protocol.md` - this audit spec
...
|-------------|---------------------|
| Protocol audit spec exists | `plan/pre-release/spec-release-audit-2-bgp-protocol.md` |
...
| File | Status | Notes |
|------|--------|-------|
| `plan/pre-release/spec-release-audit-2-bgp-protocol.md` | Created | This file |
