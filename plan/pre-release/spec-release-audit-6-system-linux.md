# Spec: release-audit-6-system-linux
...
Audit interfaces, FIB, firewall, VPP, traffic, PPPoE, L2TP, IPsec and kernel/system integration before the first user-facing release.
...
linux/QEMU/deployment finding list.
