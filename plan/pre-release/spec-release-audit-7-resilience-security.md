# Spec: release-audit-7-resilience-security
...
Audit races, shutdown, reload, authorisation, secrets, crash loops, resource exhaustion, fuzz and chaos before the first user-facing release.
...
resilience/security finding list.
