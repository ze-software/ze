...
- `ai/rules/points/rfc-compliance/` - the directive "A tag you ADD ... MUST carry a discrimination record" gains "by the mutant route where gomu can break its producer"; then `./le rules condensed-update`
