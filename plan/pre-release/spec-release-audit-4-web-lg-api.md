# Spec: release-audit-4-web-lg-api
...
Audit web UI, looking glass, REST, gRPC, MCP, SSE, authentication and empty/error states before the first user-facing release.
