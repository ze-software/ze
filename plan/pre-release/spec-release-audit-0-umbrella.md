...
9. `plan/pre-release/spec-release-evidence-gate.md` - separate work to make heavy release evidence a product gate
...
- [ ] `plan/pre-release/spec-release-evidence-gate.md` - release evidence target for heavy/non-default suites
...
- [ ] `plan/pre-release/spec-release-evidence-gate.md` - release evidence gate already planned as separate target work
...
- `plan/pre-release/spec-release-evidence-gate.md` supplies the heavyweight evidence target once implemented.
...
- `./le test integration interop`, `./le test functional exabgp-test`, `./le test qemu run command "./le test qemu all-tests"`, `./le chaos selftest unit`, `./le test fuzz run`, and deployment/perf targets supply release evidence by risk area.
...
- `plan/pre-release/spec-release-audit-0-umbrella.md` - release audit organization and blocker policy
...
- `plan/pre-release/spec-release-audit-1-surface-inventory.md` - created when inventory audit starts
- `plan/pre-release/spec-release-audit-2-bgp-protocol.md` - created when protocol audit starts
...
- `plan/pre-release/spec-release-audit-8-docs-onboarding.md` - created when docs/onboarding audit starts
...
|-------------|---------------------|
| Umbrella spec exists | `plan/pre-release/spec-release-audit-0-umbrella.md` |
...
|------------------|---------------|----------------|--------|
| No existing release evidence plan existed | `plan/pre-release/spec-release-evidence-gate.md` already exists | Glob and read of existing specs | Umbrella now depends on it instead of duplicating target work |
