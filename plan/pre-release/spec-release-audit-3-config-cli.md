# Spec: release-audit-3-config-cli
...
Audit yANG configuration, parser, validators, CLI/editor, commit/reload and pipe behaviour before the first user-facing release.
...
config/CLI coverage and bug list.
