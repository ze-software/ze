...
| `plan/future/spec-ipsec-dataplane-selector.md` | The sibling gap: no config surface selects the IPsec dataplane either |
...
`plan/future/spec-ipsec-dataplane-selector.md` must not land until this spec AND an
