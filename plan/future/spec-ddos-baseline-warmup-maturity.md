...
| Depends | - |
| Phase | - |
| Deferral shard | `plan/deferrals/fixit-ddos-baseline-lifecycle.md` |
| Handoff | - |
| Updated | 2026-08-15 |
...
`plan/deferrals/fixit-ddos-baseline-lifecycle.md`. It needs the same persisted
...
**Owning gate.** `make ze-test-pkg PKG=./internal/plugins/ddos/detect`, then
`make ze-plugin-test` for the thirteen `ddos-*.ci` fixtures.
