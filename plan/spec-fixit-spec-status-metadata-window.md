...
- `plan/spec-fixit-dynamic-group-peer-config.md`
...
- `plan/spec-rfcgate-2-deferred-rs-replay-evidence.md`
...
Fail-closed follow-up, in the same work (`ai/rules/fail-closed-guards.md`): a
