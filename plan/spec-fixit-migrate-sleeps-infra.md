...
in the retired deferral shard "fixit-chaos-reconnect-load-sensitive", which now carries the closing
...
(the retired deferral shard "fixit-chaos-reconnect-load-sensitive"). Both
...
### From `mcp2026-1-stateless-core.md`, 2026-07-29
