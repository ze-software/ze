...
they typed. It is recorded in the retired deferral shard "cli-show-bgp-is-the-command"
...
### From `cli-show-bgp-is-the-command.md`, 2026-08-19

Deferred by spec-cli-show-bgp-is-the-command.

A hint for a retired command, so an operator who types a command that used to exist is told what replaced it rather than only that it is unknown
