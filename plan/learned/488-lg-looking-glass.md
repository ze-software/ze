...
- **Birdwatcher snake_case** (over Ze's kebab-case): de facto standard for looking glass APIs. Alice-LG compatibility requires it. Documented as the only exception in `cli.md`.
...
- `ai/rules/cli.md` -- snake_case exception
