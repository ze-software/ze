...
- `internal/component/bgp/plugins/cmd/peer/yang/ze-peer-cmd.yang` (updated summary description)
...
- `internal/component/cmd/show/yang/ze-cli-show-cmd.yang` (system containers + interface type/errors; shared-WireMethod note)
