...
- `internal/component/bgp/yang/ze-bgp-api.yang` — removed daemon RPC definitions
- `internal/ipc/yang/ze-system-api.yang` — added daemon RPCs, removed standalone shutdown
