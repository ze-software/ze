...
- `ai/rules/protocol.md`, `ai/rationale/exact-or-reject.md` -- new project-wide rule surfaced by review
- `ai/rules/architecture.md`, `CLAUDE.md` -- cross-reference the new rule
