...
- `internal/component/traffic/schema/ze-traffic-cmd.yang` -- traffic command schema
- `internal/component/ike/schema/ze-ipsec-cmd.yang` -- added monitor vpn ipsec
- `internal/component/cmd/monitor/schema/` -- central monitor root (event + system-netlink only)
- `internal/component/cmd/show/schema/self_containment_test.go` -- banned token guards
- `internal/component/cmd/monitor/schema/self_containment_test.go` -- monitor banned tokens
