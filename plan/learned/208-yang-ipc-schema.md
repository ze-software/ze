...
- API YANG modules placed near their domain code (e.g., `internal/component/hub/yang/`, `internal/bgp/yang/`) rather than centrally in `internal/yang/modules/` — schema belongs to the subsystem that owns the API.
...
- `internal/component/hub/yang/`, `internal/bgp/yang/`, etc. — domain-local API YANG
