...
- `internal/component/resolve/dns/cache.go` -- O(1) LRU cache with TTL, struct keys, container/list
- `internal/component/resolve/dns/cache_test.go` -- 11 cache tests (including concurrent, overwrite, TTL=0)
- `internal/component/resolve/dns/resolver.go` -- miekg/dns client with cache integration
- `internal/component/resolve/dns/resolver_test.go` -- 19 resolver tests (A/AAAA/TXT/PTR/CNAME/MX/NS/SRV)
...
- `test/parse/system-dns-tuning.ci` -- functional test for config parsing
