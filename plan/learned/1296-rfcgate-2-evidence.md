...
which `ai/rules/completion.md` says outright cannot prove a feature is reachable.
...
- A tag in an `unrun` carrier (ipsec/l2tp/pppoe) is a hard error, over accepting it and marking it "unrun" in the ledger: a marker is a note, a refusal is a guard (`ai/rules/evidence.md`).
...
- Discovery surfaces: `ai/rules/testing.md` (+ the regenerated rule digest; CONDENSED.md was deleted 2026-08-03), `ai/rules/rfc-compliance.md`, `docs/features/rfc-status.md`, `docs/functional-tests.md`.
