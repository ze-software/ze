...
- Docs/rules: `ai/rules/cli-patterns.md`, `ai/patterns/cli-command.md`, `docs/features.md`, `docs/guide/command-reference.md`, `docs/guide/config-editor.md`, `docs/config-migration.md`.
