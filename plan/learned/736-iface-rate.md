...
- `internal/component/cmd/show/schema/ze-cli-show-cmd.yang` -- rate container
- `internal/component/bgp/plugins/cmd/monitor/schema/ze-monitor-cmd.yang` -- interface rate container
