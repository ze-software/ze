...
the retired deferral shard "yang-short-and-long-command-help" names a destination that
...
### From `yang-short-and-long-command-help.md`, 2026-08-31

Deferred by spec-yang-short-and-long-command-help.

The short/long split for CONFIG nodes: 1241 leaf and leaf-list descriptions, 443 container and list descriptions, 277 enum descriptions, and the nine config renderers that each guess a length today
