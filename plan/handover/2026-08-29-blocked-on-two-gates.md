...
| `routes_filtered` published as an unmeasured zero | Section 7.3 of `docs/architecture/api/birdwatcher-compat.md` states it outright: the count MUST be expected to be 0, ze retains no filtered routes, and the work is homed at `plan/spec-bgp-filtered-route-storage.md`. Section 7.2 is an owner decision of 2026-08-05 requiring all four counts be emitted |
