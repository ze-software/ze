...
| Depends | - |
| Phase | - |
| Deferral shard | `plan/deferrals/bgp-link-local-only-next-hop.md` |
| Handoff | - |
| Updated | 2026-09-01 |
...
(`plan/spec-rfcgate-6-supported-extraction-signoff.md`). The public row read
...
- `plan/deferrals/bgp-link-local-only-next-hop.md`
