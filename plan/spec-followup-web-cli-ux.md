...
| AC-1 tail (nav hide), AC-5 (web-route registry), AC-6,7 (i18n/mobile), AC-8,9 (completion), AC-10 (renderWriter) | NOT STARTED / PARTIAL | AC-1 enforcement DONE (route gate) but edit-control nav-hiding still open. Remainder umbrella too large for one pass (R-7) |
