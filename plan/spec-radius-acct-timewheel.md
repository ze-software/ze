...
- [ ] (if change adopted) `./le verify worktree` passes
...
### From `radius-subscriber-attributes.md`, 2026-07-10

Deferred by spec-radius-subscriber-attributes (Known Limitations).

Interim-update accounting scheduling (timer wheel)
