...
| Phase | - |
| Deferral shard | `plan/deferrals/connected-static-reach-the-locrib.md` |
| Handoff | - |
| Updated | 2026-09-04 |
...
- [ ] `plan/spec-fib-depth.md` - declared by `sysrib/ecmp.go`,
...
| Who else touches this path? | `plan/spec-fib-depth.md` (in-progress) owns `BestChangeEntry.TableID` and `ECMPPath.Weight`; `plan/spec-fixit-bgp-distance-declaration.md` owns the distance seam this spec consumes and must close first |
...
- `plan/spec-fib-depth.md` - its `ECMPPath.Weight` item is satisfied here; a
...
- `plan/deferrals/connected-static-reach-the-locrib.md`
...
| 16 | Any changed source file referenced by existing doc source anchors? | Yes | DERIVED: run `./le spec citation anchors spec plan/spec-connected-static-reach-the-locrib.md` at the start of implementation. The design owners known at spec time are `docs/architecture/core-design.md`, `docs/architecture/rib/unified-locrib.md`, `docs/architecture/rib/forward-handle.md`, `docs/architecture/static-routes.md`, `docs/architecture/forked-route-install.md`, `docs/architecture/api/process-protocol.md`, `docs/architecture/api/ipc_protocol.md` and `plan/spec-fib-depth.md`, all named above |
...
7. **Phase: the remaining surfaces** -- docs, comparison, plugin inventory
   ...
   - Files: `docs/features.md`, `docs/comparison.md`,
     ...
     `docs/config-reference.md`, `plan/spec-fib-depth.md`
...
- `BestChangeEntry.TableID` stays unpopulated by sysrib. It belongs to
  `plan/spec-fib-depth.md` and the VRF umbrella.
