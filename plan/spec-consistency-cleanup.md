...
Write `plan/spec-chunknlri-buffer-first.md` before implementing.

## Files to Create

- ~27 `doc.go` files (Phase 1.2)
- `plan/spec-chunknlri-buffer-first.md` (Phase 6 prerequisite)
...
- [ ] Write learned summary to `plan/learned/NNN-consistency-cleanup.md`
