...
1. `plan/spec-parser-unification.md` - unclear if implemented
2. No central tracking of spec status, technical debt, housekeeping
3. `plan/CLAUDE_CONTINUATION.md` - 941 lines of stale historical data, never read
...
| RECENTLY COMPLETED | 700+ | Already in `plan/done/*.md` |
...
### Deleted: plan/CLAUDE_CONTINUATION.md

- 941 lines removed
- Technical debt items preserved in TODO.md
- Historical data already exists in `plan/done/*.md` and git
...
|------|--------|
| `TODO.md` | Created |
| `plan/CLAUDE_CONTINUATION.md` | Deleted |
| `plan/spec-todo-consolidation.md` | Created |
...
| File | Reason |
|------|--------|
| `plan/spec-parser-unification.md` | Pre-existing modification |
| `plan/spec-async-api-parser.md` | Separate spec |
| `plan/spec-writeto-bounds-safety.md` | Separate spec |
...
- [x] Spec moved to `plan/done/095-procedural-improvements.md`
