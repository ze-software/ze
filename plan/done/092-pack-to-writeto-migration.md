...
- [x] `plan/done/073-spec-buffer-writer.md` - Original WriteTo design
- [x] `plan/done/075-nlri-writeto-zero-alloc.md` - NLRI WriteTo implementation
...
### Completion
- [x] Spec moved to `plan/done/092-pack-to-writeto-migration.md`
