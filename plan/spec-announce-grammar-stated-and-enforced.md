...
| Depends | - |
| Phase | 5/6 |
| Deferral shard | `plan/deferrals/announce-grammar-stated-and-enforced.md` |
| Handoff | - |
| Updated | 2026-08-30 |
...
- `plan/deferrals/announce-grammar-stated-and-enforced.md` - created only if something is deferred
...
| 16 | Any changed source file referenced by existing doc source anchors? | Yes, DERIVED | Run `./le spec citation anchors spec plan/spec-announce-grammar-stated-and-enforced.md`. The `// Design:` declarations that BLOCK are listed in Files to Modify |
