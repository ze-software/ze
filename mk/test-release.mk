...
.PHONY: ze-release-evidence ze-release-evidence-preflight ze-functional-extra-evidence ze-perf-gate
...
ze-functional-extra-evidence: $(ZEBIN_TEST)
	...
	run_extra static $(MAKE) --no-print-directory ze-static-test; \
	run_extra traffic $(MAKE) --no-print-directory ze-traffic-test; \
	run_extra vpp $(MAKE) --no-print-directory ze-vpp-test; \
	run_extra l2tp-wire $(MAKE) --no-print-directory ze-l2tp-wire-test; \
	if [ $$failed -gt 0 ]; then \
