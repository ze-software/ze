...
Build the intended peer or group with the [BGP peering guide](../../docs/guide/bgp-peering/). Validate the configuration and run ordinary interop or lab checks first. Chaos testing is useful after the normal path works, not as a substitute for basic configuration validation.
...
[chaos testing guide](../../docs/guide/chaos-testing/) for pipeline, FRR, BIRD,
and dashboard modes.
