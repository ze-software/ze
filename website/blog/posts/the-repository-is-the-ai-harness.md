...
description: Ze's repository teaches an arriving agent how to use earlier project decisions. Its guidance and checks help with the next change, provided somebody also looks after the rules.
