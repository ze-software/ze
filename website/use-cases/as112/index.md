...
```text
INTEROP_SCENARIO=as112-redistribute-lab ./le test integration interop
INTEROP_SCENARIO=as112-redistribute-origin-frr ./le test integration interop
INTEROP_SCENARIO=as112-redistribute-community-frr ./le test integration interop
```
