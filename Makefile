...
help-test:
	...
	@echo "    ---"
	@echo "    ze-static-test            Static routes (not in release gate)"
	@echo "    ze-traffic-test           Traffic control (not in release gate)"
	@echo "    ze-vpp-test               VPP stub (not in release gate)"
	@echo "    ze-l2tp-wire-test         L2TP wire-level (not in release gate)"
	@echo ""
	@echo "  Fuzz:"
	...
	@echo ""
	@echo "  Chaos:"
	@echo "    ze-chaos-test             Unit + functional + web"
