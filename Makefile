...
ze-fuzz-test:
	...
	go test -fuzz=FuzzParseOrigin -fuzztime=15s -timeout=30s ./internal/component/bgp/attribute/...
	go test -fuzz=FuzzParseMED -fuzztime=15s -timeout=30s ./internal/component/bgp/attribute/...
	go test -fuzz=FuzzParseLocalPref -fuzztime=15s -timeout=30s ./internal/component/bgp/attribute/...
	go test -fuzz=FuzzParseASPath -fuzztime=15s -timeout=30s ./internal/component/bgp/attribute/...
	go test -fuzz=FuzzParseCommunity -fuzztime=15s -timeout=30s ./internal/component/bgp/attribute/...
	go test -fuzz=FuzzParseLargeCommunity -fuzztime=15s -timeout=30s ./internal/component/bgp/attribute/...
	go test -fuzz=FuzzParseExtCommunity -fuzztime=15s -timeout=30s ./internal/component/bgp/attribute/...
	go test -fuzz=FuzzRewriteASPath -fuzztime=15s -timeout=30s ./internal/component/bgp/wireu/...
	go test -fuzz=FuzzParseNLRIs -fuzztime=15s -timeout=30s ./internal/component/bgp/wireu/...
	go test -fuzz=FuzzParseAttributes -fuzztime=15s -timeout=60s ./internal/component/bgp/plugins/bgp-rib/storage/...
	go test -fuzz=FuzzHandleRoundTrip -fuzztime=15s -timeout=30s ./internal/component/bgp/attrpool/...
	go test -fuzz=FuzzInvalidHandle -fuzztime=15s -timeout=30s ./internal/component/bgp/attrpool/...
	go test -fuzz=FuzzParseHeader -fuzztime=15s -timeout=30s ./internal/component/bgp/message/...
	go test -fuzz=FuzzUnpackOpen -fuzztime=15s -timeout=30s ./internal/component/bgp/message/...
	go test -fuzz=FuzzUnpackUpdate -fuzztime=15s -timeout=30s ./internal/component/bgp/message/...
	go test -fuzz=FuzzUnpackNotification -fuzztime=15s -timeout=30s ./internal/component/bgp/message/...
	go test -fuzz=FuzzUnpackRouteRefresh -fuzztime=15s -timeout=30s ./internal/component/bgp/message/...
	go test -fuzz=FuzzChunkNLRI -fuzztime=15s -timeout=30s ./internal/component/bgp/message/...
	go test -fuzz=FuzzParseIPv4Prefixes -fuzztime=15s -timeout=30s ./internal/component/bgp/wireu/...
	go test -fuzz=FuzzParseIPv6Prefixes -fuzztime=15s -timeout=30s ./internal/component/bgp/wireu/...
	go test -fuzz=FuzzParsePrefixes -fuzztime=15s -timeout=30s ./internal/component/bgp/wireu/...
	go test -fuzz=FuzzParseRouteDistinguisher -fuzztime=15s -timeout=30s ./internal/component/bgp/nlri/...
	go test -fuzz=FuzzParseRDString -fuzztime=15s -timeout=30s ./internal/component/bgp/nlri/...
	go test -fuzz=FuzzParseLabelStack -fuzztime=15s -timeout=30s ./internal/component/bgp/nlri/...
	go test -fuzz=FuzzParseVPN$$ -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-vpn/...
	go test -fuzz=FuzzParseVPNAddPath -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-vpn/...
	go test -fuzz=FuzzParseEVPN -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-evpn/...
	go test -fuzz=FuzzParseFlowSpec$$ -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-flowspec/...
	go test -fuzz=FuzzParseFlowSpecIPv6 -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-flowspec/...
	go test -fuzz=FuzzParseFlowSpecVPN -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-flowspec/...
	go test -fuzz=FuzzParseBGPLS$$ -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-ls/...
	go test -fuzz=FuzzParseBGPLSWithRest -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-ls/...
	go test -fuzz=FuzzParseMUP -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-mup/...
	go test -fuzz=FuzzParseMVPN -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-mvpn/...
	go test -fuzz=FuzzParseRTC -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-rtc/...
	go test -fuzz=FuzzParseVPLS -fuzztime=15s -timeout=30s ./internal/component/bgp/plugins/bgp-nlri-vpls/...
	go test -fuzz=FuzzScanner -fuzztime=15s -timeout=30s ./internal/component/bgp/textparse/...
	go test -fuzz=FuzzConfigParser -fuzztime=15s -timeout=30s ./internal/component/config
	go test -fuzz=FuzzTokenizer -fuzztime=15s -timeout=30s ./internal/component/config
