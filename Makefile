...
ze-fuzz-test:
	...
	go test -fuzz=FuzzParseOrigin -fuzztime=10s ./internal/component/bgp/plugins/bgp/attribute/...
	go test -fuzz=FuzzParseMED -fuzztime=10s ./internal/component/bgp/plugins/bgp/attribute/...
	go test -fuzz=FuzzParseLocalPref -fuzztime=10s ./internal/component/bgp/plugins/bgp/attribute/...
	go test -fuzz=FuzzParseASPath -fuzztime=10s ./internal/component/bgp/plugins/bgp/attribute/...
	go test -fuzz=FuzzParseCommunity -fuzztime=10s ./internal/component/bgp/plugins/bgp/attribute/...
	go test -fuzz=FuzzParseLargeCommunity -fuzztime=10s ./internal/component/bgp/plugins/bgp/attribute/...
	go test -fuzz=FuzzParseExtCommunity -fuzztime=10s ./internal/component/bgp/plugins/bgp/attribute/...
	go test -fuzz=FuzzRewriteASPath -fuzztime=10s ./internal/component/bgp/plugins/bgp/wireu/...
	go test -fuzz=FuzzParseNLRIs -fuzztime=10s ./internal/component/bgp/plugins/bgp/wireu/...
	go test -fuzz=. -fuzztime=10s ./internal/component/bgp/plugins/bgp-rib/storage/...
	go test -fuzz=FuzzHandleRoundTrip -fuzztime=10s ./internal/component/bgp/attrpool/...
	go test -fuzz=FuzzInvalidHandle -fuzztime=10s ./internal/component/bgp/attrpool/...

# Run a single fuzz target for longer (usage: make ze-fuzz-one FUZZ=FuzzParseNLRIs PKG=./internal/component/bgp/plugins/bgp/wireu/... TIME=30s)
FUZZ ?= FuzzParseNLRIs
PKG  ?= ./internal/component/bgp/plugins/bgp/wireu/...
TIME ?= 30s
