...
review on 2026-08-05. `build_images` now reads the image ID `docker build -q` prints,
and it pins every container of the run to that ID. It also prints the ID it resolved.
