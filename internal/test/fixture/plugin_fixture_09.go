...
func init() {
	...
	Register("plugin/med-not-propagated-across-as", rsObserver09("med-not-propagated-across-as", 3))
	Register("plugin/med-removal-before-decision", medRemovalBeforeDecision09)
	Register("plugin/med-removal-configured", rsObserver09("med-removal-configured", 2))
	Register("plugin/med-removal-export-refused", rsObserver09("med-removal-export-refused", 2))
