...
//
// Package buildgosum compares the tracked `gokrazy/ze/builddir/**/go.sum`
...
const name = "build gosum"

// Answer is the `le build gosum` command. The tree is the checkout, so there
