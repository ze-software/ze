...
const (
	...
	Baseline = "internal/le/arch/tier/testdata/tier_migration_baseline.txt"
	// NonEngineCategories is the human-readable source of truth for
	// intentional non-engine placements.
	NonEngineCategories = "internal/le/arch/tier/testdata/tier_non_engine_categories.txt"
	...
	// still caught.
	CoreImportBaseline = "internal/le/arch/tier/testdata/core_import_baseline.txt"
