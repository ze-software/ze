// Design: docs/architecture/testing/ci-format.md -- the harness command `le test rsvpte`
//
...
var suite = cli.CIRunnerConfig{
	...
	TestSubdir:      "rsvpte",
	Description:     "RSVP-TE",
	Detail:          "Run RSVP-TE functional tests (.ci files in test/rsvpte/).\nCovers single-daemon boot: config parse -> YANG -> engine startup -> show rsvp-te session/interface/tunnel/fast-reroute (incl. RFC 4090 fast-reroute config + bypass).",
	DefaultParallel: 0,
}
