// Design: docs/architecture/testing/ci-format.md -- the harness command `le test ospf`
//
...
var suite = cli.CIRunnerConfig{
	...
	TestSubdir:      "ospf",
	Description:     "OSPF",
	Detail:          "Run OSPF functional tests (.ci files in test/ospf/).\nCovers config parse -> YANG -> router-id/area validation, OSPF doctor diagnostics, and later daemon runtime scenarios.",
	DefaultParallel: 0,
}
