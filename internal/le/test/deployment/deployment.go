...
//
// Package testdeployment proves ze against software somebody else wrote. Each
...
// compared through the same recording (internal/le/test/deployment/l2tp_test.go).
