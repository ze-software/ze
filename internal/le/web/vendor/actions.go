...
// selected one gate out of an area's GateSet; `le web vendor sync` selects one
...
// printed where a developer chooses what to run: in the bare `le web vendor`
...
// Answer is the `le web vendor` command.
