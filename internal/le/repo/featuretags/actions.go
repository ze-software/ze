// Design: docs/architecture/core-design.md -- the feature-tags area, as one command
//
...
// names a fixture by calling the function.
...
// Answer is the `le repo feature-tags` command.
...
// than an error, so it answers 1 with the report; a file that could not be read
// or edited is an error and answers 1 with none.
