...
//
// report.go holds what `le repo inventory` ANSWERS, apart from what produced it.
//
...
// ITSELF (Text), because the Markdown page is what `./le repo inventory` prints.
...
// Text renders the inventory as the Markdown page `./le repo inventory` prints. It
// ends in a newline.
//
