...
//
// Package cliownership enforces the command-surface-ownership invariants:
//
...
// Answer is the `le cli ownership` command. The tree is the checkout, so
