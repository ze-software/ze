...
//
// report.go holds what `le cli list` ANSWERS, apart from what produced it.
//
...
// table is what `./le cli list` prints and what a reader pastes into a
// document.
...
// Text renders the inventory as the Markdown table `./le cli list` prints.
