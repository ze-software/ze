...
//
// actions.go ports the retired rules area. `le ai rules lint` now selects one
...
var actions = leaction.New(area,
	...
	leaction.Action{
		...
		Parameters: []leaction.Parameter{
			{Keyword: "quiet"},
			{Keyword: "transcript", Value: "path", Requirement: leaction.Optional},
			{Keyword: "session", Value: "id", Requirement: leaction.Optional},
			{Keyword: "rules-dir", Value: "path", Requirement: leaction.Optional},
			{Keyword: "no-append"},
		},
...
// Answer is the `le ai rules` command.
