...
func (r IndexReport) Text() string {
	...
	if r.Stale {
		tb.Str("WARNING: ").Str(r.File).Str(" is stale -- run: ./le ai rules index-update\n")
	}
	return tb.String()
}
...
var indexHeader = []string{
	"# Ze Rules Index",
	"",
	"<!-- GENERATED by internal/le/ai/rules/index.go -- do not edit -->",
	"<!-- Regenerate: ./le ai rules index-update -->",
	"",
