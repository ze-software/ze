...
// DriftReport is the whole answer of one `le doc yang-contract doc-drift` run.
//
...
func (r DriftReport) Text() string {
	...
	tb.Str("\n  Run: ./le doc yang-contract doc-drift\n\n")
	return tb.String()
}
...
// registered handlers.
//
// The JSON keys are the ones `./le doc yang-contract command-contract | json` publishes,
