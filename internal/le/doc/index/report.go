// Design: docs/architecture/core-design.md -- what the doc index generator answers
// Overview: docstocode.go -- the walk that fills this in
//
// report.go holds what `le doc index` ANSWERS, apart from what produced it,
...
var ErrNoAIDir = errors.New("doc index: the tree holds no ai/ directory")
