...
// VALIDATES: internal/le/go/extract moves the declarations it is asked for, moves
// nothing else, and refuses in a way that leaves both files as they were.
// PREVENTS: the three fail-open behaviors of internal/le/go/extract/register.go, each of
