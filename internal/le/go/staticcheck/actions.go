...
// Answer is the `le go staticcheck` command.
func Answer(args []string) (any, int) { return actions.Answer(args) }

// runRows is the `le go staticcheck rows` action.
...
// runCheck is the `le go staticcheck check` action.
//
