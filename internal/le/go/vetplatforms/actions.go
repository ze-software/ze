// Design: docs/architecture/core-design.md -- the go vet-platforms area, as one command
...
// Answer is the `le go vet-platforms` command. A bare command lists the two
