// Design: docs/architecture/resolve.md -- what the data asn-delegation command answers
//
// report.go holds what the one action ANSWERS, apart from what produced it.

package dataasndelegation

import (
	"github.com/ze-software/ze/internal/core/textbuf"
)

// WriteReport is what `le data asn-delegation write` answers: the delegation table file it
