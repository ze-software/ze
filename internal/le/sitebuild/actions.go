...
var actions = leaction.New(area,
	leaction.Action{Verb: "build", Why: "stage website sources and refresh the Pages artifact with native renderers", Writes: true,
		Parameters: []leaction.Parameter{{Keyword: "output", Value: "directory"}, {Keyword: "partial"}}, AnswerArgs: runBuild},
	...
	leaction.Action{Verb: "bundle", Why: "turn one presentation deck into a self-contained HTML file", Writes: true,
		Parameters: []leaction.Parameter{{Keyword: "input", Value: "html-file"}}, AnswerArgs: runBundle},
	leaction.Action{Verb: "activity", Why: "render repository line and commit activity as a presentation-ready HTML page", Writes: true,
		Parameters: []leaction.Parameter{{Keyword: "output", Value: "html-file"}, {Keyword: "days", Value: "count"}, {Keyword: "ref", Value: "revision"}, {Keyword: "today", Value: "date"}, {Keyword: "compact"}}, AnswerArgs: runActivity},
	...
	leaction.Action{Verb: "config-tree", Why: "extract the live YANG configuration tree for the public configuration reference", Writes: true,
		Parameters: []leaction.Parameter{{Keyword: "output", Value: "directory"}, {Keyword: "binary", Value: "ze-binary"}}, AnswerArgs: runConfigTree},
)
...
func runBuild(arguments leaction.Arguments) (any, int) {
	...
	report, err := Build(BuildOptions{Repository: root, Output: arguments["output"], Partial: arguments.Has("partial")})
	if err != nil {
		leaction.ReportError(err)
		return nil, 1
	}
...
func runBundle(arguments leaction.Arguments) (any, int) {
	...
	return map[string]string{"output": output}, 0
}
...
func runConfigTree(arguments leaction.Arguments) (any, int) {
	...
	paths, err := resolvePaths(root, arguments["output"])
	if err != nil {
		leaction.ReportError(err)
		return nil, 1
	}
