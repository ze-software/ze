...
func TestDocDriftRejectsUnknownWikiPipeLabel(t *testing.T) {
	for _, test := range []struct {
		...
		{"<span title='hidden: \\'>Pipes</span>, legacy: `catalog-absent`", "Pipes, legacy"},
		{"<span title=\"hidden: \\\">Pipes</span>, legacy: `catalog-absent`", "Pipes, legacy"},
		{"<span title='hidden: \\\\'>Pipes</span>, legacy: `catalog-absent`", "Pipes, legacy"},
...
func TestWikiPipeGroupLabelScansStructuralBoundary(t *testing.T) {
	for _, test := range []struct {
		...
		{
			"backslash does not escape double quote in HTML attribute",
			"<span title=\"hidden: \\\">Pipes</span>, legacy: `catalog-absent`",
			"Pipes, legacy",
			"",
		},
		{
			"backslash does not escape single quote in HTML attribute",
			"<span title='hidden: \\'>Pipes</span>, legacy: `catalog-absent`",
			"Pipes, legacy",
			"",
		},
		{
			"consecutive backslashes do not escape HTML attribute quote",
			"<span title='hidden: \\\\'>Pipes</span>, legacy: `catalog-absent`",
			"Pipes, legacy",
			"",
		},
