...
func fixture(t *testing.T) string {
	...
	write(t, root, "internal/le/pluginimports/self.go",
...
//
// This is the proof internal/le/pluginimports/pluginimports_test.go
...
//
// This is the proof internal/le/pluginimports/pluginimports.go carried as its own
