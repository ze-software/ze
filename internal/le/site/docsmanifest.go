...
var useCasePages = []sitePage{
	...
	{Source: "website/use-cases/bgp-performance/index.md", Dest: "use-cases/bgp-performance/index.html", Desc: "Route-server performance tests with le perf sender, receiver, and JSON reports.", Category: categoryAutomate, Journey: journeyUseCase},
