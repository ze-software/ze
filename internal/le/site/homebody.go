...
{whats_new}
            ...
            <section id="proof" class="home-proof-block reveal" aria-labelledby="proof-title">
                ...
                <div class="interop-strip" aria-label="Implementations Ze is tested against">
                    ...
                    <div class="interop-groups">
                        <span class="interop-group"><b>BGP</b><a href="quality/qemu-interop-release/#docker-interop">FRR</a><a href="quality/qemu-interop-release/#docker-interop">BIRD</a><a href="quality/qemu-interop-release/#docker-interop">GoBGP</a><a href="quality/qemu-interop-release/#docker-interop">OpenBGPd</a><a href="quality/qemu-interop-release/#docker-interop">FreeRtr</a><a href="quality/qemu-interop-release/#docker-interop">RustyBGP</a><a href="quality/qemu-interop-release/#docker-interop">rustbgpd</a><a href="features/exabgp-compatibility/">ExaBGP</a></span>
                        <span class="interop-group"><b>BGP support</b><a href="quality/qemu-interop-release/#docker-interop">StayRTR</a><a href="quality/qemu-interop-release/#docker-interop">pmacct</a></span>
                        <span class="interop-group"><b>VPN</b><a href="quality/qemu-interop-release/#docker-interop">strongSwan</a></span>
                        <span class="interop-group"><b>Access</b><a href="quality/qemu-interop-release/#docker-interop">accel-ppp</a><a href="quality/qemu-interop-release/#docker-interop">xl2tpd</a><a href="quality/qemu-interop-release/#docker-interop">FreeRADIUS</a></span>
                        <span class="interop-group"><b>Redundancy</b><a href="quality/qemu-interop-release/#docker-interop">keepalived</a></span>
                    </div>
                </div>
            </section>
