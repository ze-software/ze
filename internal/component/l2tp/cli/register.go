...
// codegen:skip -- cmd/ze/dispatch_l2tp.go carries the import. The skip was made because
// the harness registered a `l2tp` SUITE root of its own and linked plugin/all, so
// a generated blank import put two `l2tp` roots in one binary and
