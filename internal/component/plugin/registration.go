...
type PluginRegistration struct {
	...
	CommandShortHelp       map[string]string   // Command name -> one-line summary (from CommandDecl.ShortHelp)
	CommandDescription     map[string]string   // Command name -> long explanation (from CommandDecl.ShortHelp); absent means the plugin declared none
