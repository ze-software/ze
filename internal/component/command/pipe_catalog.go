...
func RenderOperatorReference() string {
	...
	b.WriteString("<!-- GENERATED by `./le docvalid pipe-operators-update` from\n")
	b.WriteString("     internal/component/command/pipe_catalog.go. Do not edit by hand:\n")
	b.WriteString("     `./le doc check verify` fails when this file and the catalog disagree. -->\n\n")
	b.WriteString("| Operator | Class | Surface | Argument | Repeated | What it does |\n")
	b.WriteString("|----------|-------|---------|----------|----------|--------------|\n")
	for _, op := range pipeCatalog {
		arg := op.ArgHint()
		if arg == "" {
