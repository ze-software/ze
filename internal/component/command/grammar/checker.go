...
// as pure functions, so the grammar gate (internal/le/cli/grammar/register.go), the plugin
...
// declared it. That is why roots reach this check and not CheckName, which owns
// the YANG-surface rules R1, R2, R3 and R7.
