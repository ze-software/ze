...
//
//   - show traceroute   (ze-show:traceroute)   sequential ICMP path trace   -- traceroute.go
//   - show probe-round  (ze-show:probe-round)  one parallel probe round      -- probe_round.go
//   - monitor traceroute(ze-monitor:traceroute)continuous mtr-style stream   -- monitor.go / stream.go
//   - resolve traceroute(ze-resolve:traceroute)OS traceroute with source bind-- resolve.go
//
