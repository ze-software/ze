...
// ListenerDiff computes which addresses to keep, add, and remove when
// transitioning from oldAddrs to newAddrs.
...
func (s *WebServer) Reconfigure(ctx context.Context, newAddrs []string) error {
	...
	_, toAdd, toRemove := ListenerDiff(s.bound, newAddrs)
