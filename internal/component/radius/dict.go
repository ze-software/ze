...
const (
	...
	AttrNASPortType         = 61
	// AttrEAPMessage carries one EAP packet, split across consecutive
	// instances when it exceeds 253 octets. RFC 3579 Section 3.1 gives it
	// Type 79 and Length ">= 3". eap.go splits and concatenates it.
	AttrEAPMessage           = 79
