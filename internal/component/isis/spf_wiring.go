// Design: plan/spec-isis-9-spf-rib.md -- engine <-> SPF wiring (LSDB read, next-hop, install).
...
// Related: internal/component/isis/spf -- the graph/Dijkstra/route/install package
//
