...
func TestISISAdjacencyUpVeth(t *testing.T) {
	withVethPair(t, func() {
		const cfgA = `{"isis":{"net":"49.0001.0000.0000.0001.00","interfaces":{"zeisisadj0":{"hello-interval":"1","level":"l1"}}}}`
		const cfgB = `{"isis":{"net":"49.0001.0000.0000.0002.00","interfaces":{"zeisisadj1":{"hello-interval":"1","level":"l1"}}}}`
