...
import (
	...
	"codeberg.org/thomas-mangin/ze/internal/component/isis/adjacency"
	"codeberg.org/thomas-mangin/ze/internal/component/isis/lsdb"
	"codeberg.org/thomas-mangin/ze/internal/component/isis/packet"
	"codeberg.org/thomas-mangin/ze/internal/component/isis/spf"
...
func TestISISEngineOriginateOnAdjacencyUp(t *testing.T) {
	eng := startedEngine(t, `{"isis":{"net":"49.0001.0000.0000.0001.00","interfaces":{"eth0":{"circuit-type":"point-to-point","metric":"15"}}}}`)
	defer eng.shutdown()
...
func TestISISEngineConnectedPrefixOrigination(t *testing.T) {
	eng := startedEngine(t, `{"isis":{"net":"49.0001.0000.0000.0001.00","interfaces":{"eth0":{"metric":"10"}}}}`)
	defer eng.shutdown()
...
func TestISISEngineDatabaseSnapshot(t *testing.T) {
	eng := startedEngine(t, `{"isis":{"net":"49.0001.0000.0000.0001.00","hostname":"snap-node","interfaces":{"eth0":{}}}}`)
	defer eng.shutdown()
...
func TestISISEngineOriginateCoalescesNoChange(t *testing.T) {
	...
	// input.
	eng := startedEngine(t, `{"isis":{"net":"49.0001.0000.0000.0001.00","interfaces":{"eth0":{"circuit-type":"point-to-point","metric":"10"}}}}`)
	defer eng.shutdown()
	node := eng.cfg.SystemID
