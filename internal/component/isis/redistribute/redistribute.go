// Design: plan/spec-isis-11-redistribution.md -- IS-IS redistribution (both directions).
// Related: internal/component/isis/lsdb -- PrefixInfo (TLV 135) origination input.
// Related: internal/component/isis/redistribute/events -- redistevents producer wiring.
//
