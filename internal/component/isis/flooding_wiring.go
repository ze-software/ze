// Design: plan/spec-isis-7-flooding.md -- engine <-> flooding wiring (handlers, timers, P2P initial CSNP).
...
// (isis-3/isis-4) and the flooding subsystem (isis-7, internal/component/isis/lsdb
