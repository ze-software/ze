...
import (
	...
	"codeberg.org/thomas-mangin/ze/internal/component/isis/lsdb"
	"codeberg.org/thomas-mangin/ze/internal/component/isis/packet"
	"codeberg.org/thomas-mangin/ze/internal/component/isis/transport"
	"codeberg.org/thomas-mangin/ze/internal/component/isis/types"
...
func TestISISLSDBSync(t *testing.T) {
	...
	const cfgA = `{"isis":{"net":"49.0001.0000.0000.0001.00","level":"l1","interfaces":{"eth0":{"hello-interval":"1","level":"l1","circuit-type":"point-to-point"}}}}`
	const cfgB = `{"isis":{"net":"49.0001.0000.0000.0002.00","level":"l1","interfaces":{"eth0":{"hello-interval":"1","level":"l1","circuit-type":"point-to-point"},"eth1":{"hello-interval":"1","level":"l1","circuit-type":"point-to-point"}}}}`
	const cfgC = `{"isis":{"net":"49.0001.0000.0000.0003.00","level":"l1","interfaces":{"eth0":{"hello-interval":"1","level":"l1","circuit-type":"point-to-point"}}}}`
...
func TestISISFloodSRMTimer(t *testing.T) {
	...
	const cfgA = `{"isis":{"net":"49.0001.0000.0000.0001.00","level":"l1","interfaces":{"eth0":{"hello-interval":"1","level":"l1","circuit-type":"point-to-point"}}}}`
	const cfgB = `{"isis":{"net":"49.0001.0000.0000.0002.00","level":"l1","interfaces":{"eth0":{"hello-interval":"1","level":"l1","circuit-type":"point-to-point"}}}}`
...
func TestISISCSNPGapRequest(t *testing.T) {
	...
	const cfg = `{"isis":{"net":"49.0001.0000.0000.0001.00","level":"l1","interfaces":{"eth0":{"hello-interval":"1","level":"l1","circuit-type":"point-to-point"}}}}`
