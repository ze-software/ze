...
func TestISISShowHostnameRender(t *testing.T) {
	eng := startedEngine(t, `{"isis":{"net":"49.0001.0000.0000.0001.00","hostname":"ze-router","interfaces":{"eth0":{"circuit-type":"point-to-point"}}}}`)
	defer eng.shutdown()
...
func TestISISShowHostnameSkipsNoTLV137(t *testing.T) {
	eng := startedEngine(t, `{"isis":{"net":"49.0001.0000.0000.0001.00","interfaces":{"eth0":{"circuit-type":"point-to-point"}}}}`)
	defer eng.shutdown()
...
func TestISISShowInterfaceRender(t *testing.T) {
	eng := startedEngine(t, `{"isis":{"net":"49.0001.0000.0000.0001.00","interfaces":{"eth0":{"circuit-type":"point-to-point","metric":"42","hello-interval":"3"},"lo":{"passive":"true"}}}}`)
	defer eng.shutdown()
