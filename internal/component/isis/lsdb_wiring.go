// Design: plan/spec-isis-6-lsdb.md -- engine <-> LSDB wiring (origination trigger, aging loop).
...
// (isis-5) and the LSDB subsystem (isis-6, internal/component/isis/lsdb). It owns
