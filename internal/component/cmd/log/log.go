...
func init() {
	pluginserver.RegisterRPCs(
		pluginserver.RPCRegistration{WireMethod: "ze-bgp:log-levels", Handler: handleLogLevels, Help: "Subsystem log levels", ReadOnly: true},
		pluginserver.RPCRegistration{WireMethod: "ze-bgp:log-set", Handler: handleLogSet, Help: "Set subsystem log level at runtime"},
	)
}
