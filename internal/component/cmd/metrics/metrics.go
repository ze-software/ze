...
func init() {
	pluginserver.RegisterRPCs(
		pluginserver.RPCRegistration{WireMethod: "ze-bgp:metrics-values", Handler: handleMetricsValues, Help: "Prometheus metrics (text format)", ReadOnly: true},
		pluginserver.RPCRegistration{WireMethod: "ze-bgp:metrics-list", Handler: handleMetricsList, Help: "List metric names", ReadOnly: true},
	)
}
