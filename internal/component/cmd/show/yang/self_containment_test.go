...
func TestShowSchemaHasNoMigratedOwnerCommands(t *testing.T) {
	banned := map[string]string{
		`"ze-show:flow-export"`:           "flow export -> internal/component/flowexport/yang",
		`"ze-show:rsvp-te-`:               "RSVP-TE -> internal/component/rsvpte/yang",
		`"ze-show:ldp-`:                   "LDP -> internal/component/ldp/yang",
		...
		`"ze-show:ip-arp"`:                "kernel ARP/ND read -> internal/component/iface/yang",
		`"ze-show:ip-route"`:              "kernel FIB read -> internal/component/iface/yang",
		`"ze-show:route-lookup"`:          "kernel FIB lookup -> internal/component/iface/yang",
		`"ze-show:neighbors"`:             "kernel neighbor read -> internal/component/iface/yang",
		`"ze-show:kernel-routes"`:         "kernel FIB read -> internal/component/iface/yang",
		`"ze-show:ping"`:                  "ICMP ping -> internal/component/ping/yang",
		`"ze-show:traceroute"`:            "ICMP traceroute -> internal/component/traceroute/yang",
		`"ze-show:probe-round"`:           "parallel probe round -> internal/component/traceroute/yang",
		...
		`"ze-show:traffic"`:               "traffic control (QoS) -> internal/component/traffic/yang",
		`"ze-show:dns-lookup"`:            "DNS lookup -> internal/component/resolve/yang",
		`"ze-show:dns-cache"`:             "DNS cache inspection -> internal/component/resolve/yang",
		...
		`"ze-show:pki-certificates"`:      "PKI certificate list -> internal/component/pki/yang",
		`"ze-show:pki-certificate"`:       "PKI certificate detail -> internal/component/pki/yang",
		`"ze-show:l2tp-health"`:           "L2TP health -> internal/component/l2tp/yang",
		`"ze-show:storage-smart"`:         "storage SMART -> internal/component/storage/yang",
		`"ze-show:gnmi"`:                  "gNMI server status -> internal/component/gnmi/yang",
		`"ze-show:aaa-accounting"`:        "AAA accounting -> internal/component/aaa/yang",
		`"ze-show:mpls-forwarding"`:       "MPLS forwarding -> internal/component/mpls/yang",
