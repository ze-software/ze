// Design: plan/spec-diag-0-umbrella.md -- pcap writer (stdlib-only)
...
// writePcapHeader writes the 24-byte pcap global header.
...
// writePcapPacket writes one pcap packet record (16-byte header + data).
