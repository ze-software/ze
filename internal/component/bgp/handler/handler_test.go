...
func TestBgpHandlerRPCs(t *testing.T) {
	...
	// 7 peer ops + 3 summary/caps/clear + 8 introspection + 1 cache + 1 commit + 1 raw + 3 refresh + 1 update + 5 rib meta = 30
	assert.Len(t, rpcs, 30, "expected 30 BGP handler RPCs")
