...
// Design: docs/architecture/buffer-architecture.md -- zero-copy, copy-on-modify (Incoming Peer Pool buffer allocated at receive)
...
type Session struct {
	...
	// Set by Peer to link to plugin.Server.GetPluginCapabilitiesForSelectors().
