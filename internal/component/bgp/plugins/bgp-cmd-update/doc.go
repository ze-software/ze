// Package bgpcmdupdate provides BGP route announcement parsing command handlers.
...
import (
	_ "codeberg.org/thomas-mangin/ze/internal/component/bgp/plugins/bgp-cmd-update/schema" // init() registers YANG module
)
