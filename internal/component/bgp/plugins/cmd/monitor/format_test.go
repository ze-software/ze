...
func TestFormatMonitorLineUpdate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			json: `{"type":"bgp","bgp":{"message":{"type":"update","direction":"received"},"peer":{"remote":{"address":"10.0.0.1","as":65001}},"update":{"nlri":{"ipv4/unicast":[{"next-hop":"10.0.1.254","action":"add","nlri":["10.0.1.0/24"]}]}}}}`,
			want: "recv UPDATE 10.0.0.1 AS65001 +10.0.1.0/24 nhop=10.0.1.254",
		},
		{
			name: "announce_multiple_prefixes",
			json: `{"type":"bgp","bgp":{"message":{"type":"update","direction":"received"},"peer":{"remote":{"address":"10.0.0.1","as":65001}},"update":{"nlri":{"ipv4/unicast":[{"next-hop":"10.0.1.254","action":"add","nlri":["10.0.1.0/24","10.0.2.0/24","10.0.3.0/24"]}]}}}}`,
			want: "recv UPDATE 10.0.0.1 AS65001 +10.0.1.0/24 +10.0.2.0/24 +10.0.3.0/24 nhop=10.0.1.254",
		},
		{
			name: "withdraw",
			json: `{"type":"bgp","bgp":{"message":{"type":"update","direction":"received"},"peer":{"remote":{"address":"10.0.0.1","as":65001}},"update":{"nlri":{"ipv4/unicast":[{"action":"del","nlri":["10.0.3.0/24"]}]}}}}`,
			want: "recv UPDATE 10.0.0.1 AS65001 -10.0.3.0/24",
		},
		{
			name: "sent_update",
			json: `{"type":"bgp","bgp":{"message":{"type":"update","direction":"sent"},"peer":{"remote":{"address":"10.0.0.2","as":65002}},"update":{"nlri":{"ipv4/unicast":[{"next-hop":"10.0.0.1","action":"add","nlri":["10.0.4.0/24"]}]}}}}`,
...
func TestFormatMonitorLineState(t *testing.T) {
	tests := []struct {
		...
		{
			name: "peer_up",
			json: `{"type":"bgp","bgp":{"message":{"type":"state"},"peer":{"remote":{"address":"10.0.0.1","as":65001}},"state":"established"}}`,
			want: "---- STATE  10.0.0.1 AS65001 established",
		},
		{
			name: "peer_down_with_reason",
			json: `{"type":"bgp","bgp":{"message":{"type":"state"},"peer":{"remote":{"address":"10.0.0.1","as":65001}},"state":"down","reason":"notification"}}`,
...
func TestFormatMonitorLineOther(t *testing.T) {
	tests := []struct {
		...
		{
			name: "keepalive",
			json: `{"type":"bgp","bgp":{"message":{"direction":"received","type":"keepalive"},"peer":{"remote":{"address":"10.0.0.1","as":65001}}}}`,
			want: "recv KALIVE 10.0.0.1 AS65001",
		},
		{
			name: "eor",
			json: `{"type":"bgp","bgp":{"message":{"type":"eor"},"peer":{"remote":{"address":"10.0.0.1","as":65001}},"eor":{"family":"ipv4/unicast"}}}`,
			want: "---- EOR    10.0.0.1 AS65001 ipv4/unicast",
		},
		{
			name: "open",
			json: `{"type":"bgp","bgp":{"message":{"direction":"received","type":"open"},"peer":{"remote":{"address":"10.0.0.1","as":65001}},"open":{"timer":{"hold-time":90},"router-id":"1.2.3.4"}}}`,
			want: "recv OPEN   10.0.0.1 AS65001 hold=90 id=1.2.3.4",
		},
		{
			name: "notification",
			json: `{"type":"bgp","bgp":{"message":{"direction":"received","type":"notification"},"peer":{"remote":{"address":"10.0.0.1","as":65001}},"notification":{"code":6,"subcode":4}}}`,
			want: "recv NOTIF  10.0.0.1 AS65001 6/4",
		},
		{
			name: "refresh",
			json: `{"type":"bgp","bgp":{"message":{"direction":"received","type":"refresh"},"peer":{"remote":{"address":"10.0.0.1","as":65001}}}}`,
			want: "recv RFRSH  10.0.0.1 AS65001",
		},
		{
			name: "negotiated",
			json: `{"type":"bgp","bgp":{"message":{"type":"negotiated"},"peer":{"remote":{"address":"10.0.0.1","as":65001}}}}`,
