...
func init() {
	pluginserver.RegisterRPCs(
		pluginserver.RPCRegistration{WireMethod: "ze-bgp:peer-raw", CLICommand: "peer raw", Handler: handleRaw, Help: "Send raw bytes to peer (no validation)", RequiresSelector: true},
	)
}
