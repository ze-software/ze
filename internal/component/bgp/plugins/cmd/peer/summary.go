...
func init() {
	pluginserver.RegisterRPCs(
		pluginserver.RPCRegistration{WireMethod: "ze-bgp:summary", CLICommand: "summary", Handler: handleBgpSummary, Help: "Show BGP summary (peer table with statistics)", ReadOnly: true},
		pluginserver.RPCRegistration{WireMethod: "ze-bgp:peer-capabilities", CLICommand: "peer capabilities", Handler: handleBgpPeerCapabilities, Help: "Negotiated capabilities for peer(s)", ReadOnly: true},
		pluginserver.RPCRegistration{WireMethod: "ze-bgp:peer-statistics", CLICommand: "peer statistics", Handler: handleBgpPeerStatistics, Help: "Per-peer update statistics with rates", ReadOnly: true},
	)
}
