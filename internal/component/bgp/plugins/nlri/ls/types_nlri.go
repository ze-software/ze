...
func NewBGPLSNode(proto BGPLSProtocolID, id uint64, localNode NodeDescriptor) *BGPLSNode {
	return &BGPLSNode{nlriType: BGPLSNodeNLRI, protocolID: proto, identifier: id, LocalNode: localNode}
}
...
func NewBGPLSLink(proto BGPLSProtocolID, id uint64, local, remote NodeDescriptor, link LinkDescriptor) *BGPLSLink {
	return &BGPLSLink{nlriType: BGPLSLinkNLRI, protocolID: proto, identifier: id, LocalNode: local,
		RemoteNode: remote,
		LinkDesc:   link}
}
...
func NewBGPLSPrefixV4(proto BGPLSProtocolID, id uint64, node NodeDescriptor, prefix PrefixDescriptor) *BGPLSPrefix {
	return &BGPLSPrefix{nlriType: BGPLSPrefixV4NLRI, protocolID: proto, identifier: id, LocalNode: node,
		PrefixDesc: prefix}
}
...
func NewBGPLSPrefixV6(proto BGPLSProtocolID, id uint64, node NodeDescriptor, prefix PrefixDescriptor) *BGPLSPrefix {
	return &BGPLSPrefix{nlriType: BGPLSPrefixV6NLRI, protocolID: proto, identifier: id, LocalNode: node,
		PrefixDesc: prefix}
}
