...
//
// Package bgpcmdmeta provides BGP command discovery, help, completion,
...
import (
	_ "codeberg.org/thomas-mangin/ze/internal/component/bgp/plugins/bgp-cmd-meta/schema" // init() registers YANG module
)
