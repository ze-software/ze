...
func TestRIBPluginFiveStageProtocol(t *testing.T) {
	...
	assert.Contains(t, commandNames, "show bgp rib status")
	...
	assert.Contains(t, commandNames, "request bgp rib mark-stale")
	assert.Contains(t, commandNames, "request bgp rib purge-stale")
	...
	assert.Contains(t, commandNames, "show bgp rib help")
	assert.Contains(t, commandNames, "show bgp rib commands")
	assert.Contains(t, commandNames, "show bgp rib events")
