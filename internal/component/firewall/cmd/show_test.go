...
func TestFormatActionTypes(t *testing.T) {
	tests := []struct {
		...
		{"masquerade ports", firewall.Masquerade{Port: 1024, PortEnd: 65535}, "masquerade to :1024-65535"},
		{"masquerade single port", firewall.Masquerade{Port: 8080}, "masquerade to :8080"},
