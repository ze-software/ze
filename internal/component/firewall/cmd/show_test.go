...
func TestFormatActionTypes(t *testing.T) {
	tests := []struct {
		...
		{"masquerade ports", firewall.Masquerade{Port: 1024, PortEnd: 65535}, "masquerade port-range 1024-65535"},
		{"masquerade single port", firewall.Masquerade{Port: 8080}, "masquerade port-range 8080"},
		{"masquerade random", firewall.Masquerade{Flags: firewall.MasqFlagRandom}, "masquerade random"},
		{"masquerade random full", firewall.Masquerade{Flags: firewall.MasqFlagFullyRandom}, "masquerade random full"},
		{"masquerade persistent", firewall.Masquerade{Flags: firewall.MasqFlagPersistent}, "masquerade persistent"},
		{"masquerade random+persistent", firewall.Masquerade{Flags: firewall.MasqFlagRandom | firewall.MasqFlagPersistent}, "masquerade random persistent"},
