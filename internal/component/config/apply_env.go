...
var envPlumbingTable = []envPlumbing{
	...
	{section: "reactor", option: "forward-queue-size", envKey: "ze.fwd.chan.size"},
	{section: "reactor", option: "forward-batch-limit", envKey: "ze.fwd.batch.limit"},
	{section: "reactor", option: "forward-pool-max-bytes", envKey: "ze.fwd.pool.maxbytes"},
	{section: "reactor", option: "forward-pool-headroom", envKey: "ze.fwd.pool.headroom"},
	{section: "reactor", option: "forward-teardown-grace", envKey: "ze.fwd.teardown.grace"},
	{section: "reactor", option: "read-buffer-size", envKey: "ze.buf.read.size"},
	{section: "reactor", option: "write-buffer-size", envKey: "ze.buf.write.size"},
