...
var envPlumbingTable = []envPlumbing{
	{section: sectionDaemon, option: "pid", envKey: "ze.pid.file"},
	{section: sectionDaemon, option: "user", envKey: "ze.user"},
	{section: sectionBGP, option: "openwait", envKey: "ze.bgp.openwait"},
	{section: sectionBGP, option: "announce-delay", envKey: "ze.bgp.announce.delay"},
	{section: sectionChaos, option: "seed", envKey: "ze.bgp.chaos.seed"},
	{section: sectionChaos, option: "rate", envKey: "ze.bgp.chaos.rate"},
	{section: sectionReactor, option: "speed", envKey: "ze.bgp.reactor.speed"},
	{section: sectionReactor, option: "cache-ttl", envKey: "ze.bgp.reactor.cache-ttl"},
	{section: sectionReactor, option: "cache-max", envKey: "ze.bgp.reactor.cache-max"},
	{section: sectionReactor, option: "update-groups", envKey: "ze.bgp.reactor.update-groups"},
	{section: sectionReactor, option: "coalesce", envKey: "ze.bgp.reactor.coalesce"},
	{section: sectionReactor, option: "forward-queue-size", envKey: "ze.fwd.chan.size"},
	{section: sectionReactor, option: "forward-batch-limit", envKey: "ze.fwd.batch.limit"},
	{section: sectionReactor, option: "forward-pool-max-bytes", envKey: "ze.fwd.pool.maxbytes"},
	{section: sectionReactor, option: "forward-pool-headroom", envKey: "ze.fwd.pool.headroom"},
	{section: sectionReactor, option: "forward-teardown-grace", envKey: "ze.fwd.teardown.grace"},
	{section: sectionReactor, option: "read-buffer-size", envKey: "ze.buf.read.size"},
	{section: sectionReactor, option: "write-buffer-size", envKey: "ze.buf.write.size"},
