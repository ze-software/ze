...
func TestCallToolGeneratedViaHTTP(t *testing.T) {
	var dispatched string
	handler := Handler(
		func(cmd, _, _ string) (string, error) {
			dispatched = cmd
...
func TestDispatchGeneratedDispatchError(t *testing.T) {
	...
	s := &server{
		dispatch: func(_, _, _ string) (string, error) {
...
func TestCallToolUnknownViaHTTP(t *testing.T) {
	...
	handler := Handler(
		func(_, _, _ string) (string, error) { return "", nil },
...
func TestBearerTokenAuth(t *testing.T) {
	handler := Handler(
		func(_, _, _ string) (string, error) { return "ok", nil },
		nil,
		"secret-token-123",
	)
