...
func newElicitTestSession(t *testing.T, r *sessionRegistry) (*session, *mockSink, func()) {
	t.Helper()
	sess, err := r.CreateWithCapabilities(ProtocolVersion, Identity{}, true, false, false)
	if err != nil {
...
func TestRegistry_CreateWithCapabilities(t *testing.T) {
	...
	sess2, err := r.CreateWithCapabilities(ProtocolVersion, Identity{}, false, false, false)
	if err != nil {
