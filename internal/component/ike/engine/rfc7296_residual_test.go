...
// plan/spec-rfcgate-1b-rfc7296-pilot.md, strengthening only. Adds the errors import
...
func TestResInitialContactSentByNonReplicableIdentity(t *testing.T) {
	// rfc-test-change-approved: 2026-07-31 owner standing approval for
	// plan/spec-rfcgate-1b-rfc7296-pilot.md, strengthening only. The predicate is
...
func TestResExpiredSAIsNotUsed(t *testing.T) {
	...
	for _, c := range []struct {
		...
		t.Run(c.name, func(t *testing.T) {
			...
			// rfc-test-change-approved: 2026-07-31 owner standing approval for
			// plan/spec-rfcgate-1b-rfc7296-pilot.md, strengthening only. The refusal is
...
func TestResRekeyLeadLeavesRoomBeforeHardExpiry(t *testing.T) {
	...
	for _, c := range []struct {
		...
		t.Run(c.name, func(t *testing.T) {
			// rfc-test-change-approved: 2026-07-31 owner standing approval for
			// plan/spec-rfcgate-1b-rfc7296-pilot.md, strengthening only. Loop form only;
...
// rfc-test-change-approved: 2026-07-31 owner standing approval for
// plan/spec-rfcgate-1b-rfc7296-pilot.md, strengthening only. Adds two new tests
...
// rfc-test-change-approved: 2026-07-31 owner standing approval for
// plan/spec-rfcgate-1b-rfc7296-pilot.md, strengthening only. The previous
