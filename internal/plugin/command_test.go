...
func TestDispatcherRegister(t *testing.T) {
	...
	handler := func(ctx *CommandContext, args []string) (*Response, error) {
...
func TestDispatcherLongestMatch(t *testing.T) {
	...
	var matched string
	d.Register("peer", func(ctx *CommandContext, args []string) (*Response, error) {
		matched = "peer"
		return &Response{Status: "done"}, nil
	}, "")
	d.Register("peer show", func(ctx *CommandContext, args []string) (*Response, error) {
		matched = "peer show"
		return &Response{Status: "done"}, nil
	}, "")
	d.Register("peer show extensive", func(ctx *CommandContext, args []string) (*Response, error) {
...
func TestDispatcherHandlerError(t *testing.T) {
	...
	d.Register("fail", func(ctx *CommandContext, args []string) (*Response, error) {
