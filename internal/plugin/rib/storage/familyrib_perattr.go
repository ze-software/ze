...
// FamilyRIBPerAttr stores routes with per-attribute-type deduplication.
...
// NewFamilyRIBPerAttr creates a FamilyRIB using per-attribute storage.
func NewFamilyRIBPerAttr(family nlri.Family, addPath bool) *FamilyRIBPerAttr {
	return &FamilyRIBPerAttr{
		family:  family,
		addPath: addPath,
...
func (r *FamilyRIBPerAttr) Insert(attrBytes []byte, nlriBytes []byte) {
...
func (r *FamilyRIBPerAttr) Remove(nlriBytes []byte) bool {
	nlriKey := string(nlriBytes)
...
func (r *FamilyRIBPerAttr) Release() {
...
func (r *FamilyRIBPerAttr) Family() nlri.Family {
	return r.family
}

// HasAddPath returns whether ADD-PATH is enabled.
func (r *FamilyRIBPerAttr) HasAddPath() bool {
	return r.addPath
}
