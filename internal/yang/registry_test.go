...
func TestCheckAllValidatorsRegistered_AllPresent(t *testing.T) {
	...
	reg.Register("registered-address-family", CustomValidator{
		ValidateFn: func(path string, value any) error { return nil },
	})
	reg.Register("nonzero-ipv4", CustomValidator{
		ValidateFn: func(path string, value any) error { return nil },
	})
	reg.Register("literal-self", CustomValidator{
		ValidateFn: func(path string, value any) error { return nil },
	})
	reg.Register("community-range", CustomValidator{
		ValidateFn: func(path string, value any) error { return nil },
	})

	err := CheckAllValidatorsRegistered(loader, reg)
