...
// schema modules (ze schema list), and show subcommands
// (ze completion words show).
...
_ze() {
    ...
    local commands="bgp config cli exabgp interface plugin schema show status signal completion version help"
