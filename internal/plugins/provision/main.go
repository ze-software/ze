...
func generateConfig(p configParams) string {
	...
	b.Str("    dhcp-server {\n")
	b.Str("        enabled true;\n")
	b.Str("        listen-interface ")
	b.Str(p.iface)
	b.Str(";\n")
	b.Str("        shared-network install {\n")
	b.Str("            subnet ")
	b.Str(p.network)
	b.Str(" {\n")
	b.Str("                range pool1 {\n")
	...
	b.Str(p.serverIP)
	b.Str(";\n")
	b.Str("            bootfile-bios ipxe.pxe;\n")
	b.Str("            bootfile-uefi ipxe.efi;\n")
	if p.bootScriptURL != "" {
		b.Str("            boot-script-url ")
		b.Str(p.bootScriptURL)
		b.Str(";\n")
	}
	b.Str("        }\n")
	b.Str("    }\n")
	...
	b.Str(p.iface)
	b.Str(";\n")
	b.Str("        image-directory ")
	b.Str(dirOf(p.image))
	b.Str(";\n")
	b.Str("        boot-directory ")
	b.Str(bootRoot)
	b.Str(";\n")
	b.Str("        ssh-username ")
	b.Str(p.sshUsername)
	b.Str(";\n")
	b.Str("        ssh-password-hash \"")
	b.Str(p.sshPassHash)
	b.Str("\";\n")
	b.Str("        rescue-auth \"")
	b.Str(p.rescueAuth)
