...
const (
	...
	// The native appliance builder stages the kernel, initrd, and iPXE binaries
	// here. Provision serves boot files from <pxe-dir>/boot and TFTP from
	// <pxe-dir>/tftp; --pxe-dir overrides the root (for example
