// Design: plan/spec-ospf-af-unify.md -- the OSPFv3 Codec adapter over ospfv3/packet. It
...
// v6Codec is the OSPFv3 Codec adapter over internal/plugins/ospfv3/packet.
type v6Codec struct{}
