...
func TestHandleVizRouteMatrix(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/route-matrix", http.NoBody)
...
func TestHandleVizRouteMatrixTopParam(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/route-matrix?top=10", http.NoBody)
	w := httptest.NewRecorder()
...
func TestHandleVizRouteMatrixLatencyMode(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/route-matrix?mode=latency", http.NoBody)
	w := httptest.NewRecorder()
...
func TestHandleVizRouteMatrixFamilyFilter(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/route-matrix?family=ipv4/unicast", http.NoBody)
	w := httptest.NewRecorder()
	d.handleVizRouteMatrix(w, req)
...
func TestHandleVizRouteMatrixCustomPeers(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/route-matrix?peers=0,1", http.NoBody)
	w := httptest.NewRecorder()
	d.handleVizRouteMatrix(w, req)
...
func TestHandleVizEvents(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/events", http.NoBody)
	w := httptest.NewRecorder()
...
func TestHandleVizEventsPeerFilter(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/events?peer=1", http.NoBody)
	w := httptest.NewRecorder()
...
func TestHandleVizEventsTypeFilter(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/events?type=chaos", http.NoBody)
	w := httptest.NewRecorder()
...
func TestHandleVizConvergence(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/convergence", http.NoBody)
	w := httptest.NewRecorder()
...
func TestHandleVizPeerTimeline(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/peer-timeline", http.NoBody)
	w := httptest.NewRecorder()
...
func TestHandleVizPeerTimelinePagination(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/peer-timeline?page=1", http.NoBody)
	w := httptest.NewRecorder()
	d.handleVizPeerTimeline(w, req)
	page1 := w.Body.String()

	// Page 2 should have p30+ but not p0.
	req = httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/peer-timeline?page=2", http.NoBody)
	w = httptest.NewRecorder()
	d.handleVizPeerTimeline(w, req)
	page2 := w.Body.String()
...
func TestHandleVizChaosTimeline(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/viz/chaos-timeline", http.NoBody)
	w := httptest.NewRecorder()
