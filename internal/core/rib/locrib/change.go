// Design: docs/architecture/rib/unified-locrib.md -- Loc-RIB change notifications
// Design: docs/architecture/rib/forward-handle.md -- Change.Forward handle for zero-copy forwarding
