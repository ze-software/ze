...
//
// Production code uses RealClock which delegates directly to the standard
// library with zero overhead beyond interface dispatch. Simulation and
// testing code can inject virtual clocks for deterministic, fast execution.
//
