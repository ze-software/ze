...
Usage:
    python3 test/interop-pppoe/run.py                       # run all scenarios
    python3 test/interop-pppoe/run.py 01-pppoe-chap-ipv4    # one scenario
    VERBOSE=1 python3 test/interop-pppoe/run.py             # verbose output
