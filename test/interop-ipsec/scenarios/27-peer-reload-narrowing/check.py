#!/usr/bin/env python3
"""Scenario 27: Ze's own child policy narrows mid-tunnel, Ze -> strongSwan.
...
WHY THIS IS THE MIRROR OF SCENARIO 13. There, the PEER's policy narrows and Ze follows it.
Here, ZE's policy narrows and the peer follows. The two ends of one obligation: scenario
13 proves Ze withdraws a selector it was told to stop protecting, this one proves Ze can
...
This is the same action charon takes in scenario 13.

Run one scenario: `make ze-interop-ipsec-test IPSEC_INTEROP_SCENARIO=27-peer-reload-narrowing`.
"""
