#!/usr/bin/env python3
"""Scenario initiator-rekey-answer-narrows: strongSwan answers Ze's Child SA rekey below the scope in use.
...
Run one scenario: `make ze-interop-ipsec-test IPSEC_INTEROP_SCENARIO=initiator-rekey-answer-narrows`.
"""
