#!/usr/bin/env python3
"""Scenario responder-ike-rekey: IKE-SA rekey responder Ze <- strongSwan (charon rekeys the IKE SA).
...
def check():
    ...
    #    are not captured in the container, per scenario child-rekey): a successful rekey it
