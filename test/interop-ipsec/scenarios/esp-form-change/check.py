#!/usr/bin/env python3
"""Scenario esp-form-change: one live Child SA carries an ESP form its kernel state refuses.
...
def check():
    ...
    #    witness -- scenario child-rekey asserts the same set CHANGES on a rekey, so an
