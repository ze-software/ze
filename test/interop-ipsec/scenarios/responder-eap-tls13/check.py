#!/usr/bin/env python3
"""Scenario responder-eap-tls13: EAP-TLS 1.3 responder, Ze <- strongSwan (charon is the EAP client).
...
Why this scenario had to be built: scenarios eap-tls and eap-tls13 both put strongSwan in
