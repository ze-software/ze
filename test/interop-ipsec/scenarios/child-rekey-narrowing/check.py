#!/usr/bin/env python3
"""Scenario child-rekey-narrowing: the peer's child policy narrows mid-tunnel, Ze <- strongSwan.
...
Run one scenario: `make ze-interop-ipsec-test IPSEC_INTEROP_SCENARIO=child-rekey-narrowing`.
"""
