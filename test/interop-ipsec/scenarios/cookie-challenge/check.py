#!/usr/bin/env python3
"""Scenario cookie-challenge: strongSwan completes a handshake Ze answered with a COOKIE.
...
def check():
    ...
    # 3. Kernel state and data plane, as scenario psk-site-to-site asserts them.
