#!/usr/bin/env python3
"""Scenario delete-while-window-held: Ze raises no second request while one is unanswered (RFC 7296 §2.3).
...
NOTE: requires the Docker strongSwan interop lab; run under
      `make ze-interop-ipsec-test IPSEC_INTEROP_SCENARIO=delete-while-window-held`.
"""
