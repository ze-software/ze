...
flush('peer * update text origin igp path 65001 nhop 172.30.0.2 community [65001:100 65001:200] nlri ipv4/unicast add 10.10.0.0/24\n')
time.sleep(0.1)

# Announce route with large community.
flush('peer * update text origin igp path 65001 nhop 172.30.0.2 large-community [65001:0:1] nlri ipv4/unicast add 10.10.1.0/24\n')
