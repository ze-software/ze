#!/usr/bin/env python3
"""Scenario ospf-v6-gr-fib-retention: non-stop forwarding across a Ze OSPFv3 restart.
...
def check():
    ...
    log_pass("ospf-v6-gr-fib-retention: RTPROT_ZE routes retained across the restart")
