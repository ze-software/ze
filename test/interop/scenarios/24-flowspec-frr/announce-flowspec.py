...
flush(
    "peer * update text extended-community [rate-limit:0] nhop 172.30.0.2 nlri ipv4/flow add destination 10.99.0.0/24\n"
)
wait_for_ack(1)
...
flush(
    "peer * update text extended-community [rate-limit:9600] nhop 172.30.0.2 nlri ipv4/flow add destination 10.99.1.0/24 source 10.0.0.0/8 protocol tcp\n"
)
wait_for_ack(2)
