...
def check():
    ...
    if (
        "add-path" in output.lower()
        or "Add-Path" in output
        or "addpath" in output.lower()
    ):
    ...
    route_output = docker_exec_quiet(
