...
flush('bgp peer * update text origin igp path 65001 nhop 172.30.0.2 nlri ipv4/unicast add 10.10.0.0/24\n')
time.sleep(0.1)
flush('bgp peer * update text origin igp path 65001 nhop 172.30.0.2 nlri ipv4/unicast add 10.10.1.0/24\n')
time.sleep(0.1)
flush('bgp peer * update text origin igp path 65001 nhop 172.30.0.2 nlri ipv4/unicast add 10.10.2.0/24\n')
