#!/usr/bin/env python3
"""Scenario ospf-v6-broadcast-frr: OSPFv3 DR/BDR election + Network-LSA on a broadcast LAN.
...
def check():
    ...
    log_pass(
        "ospf-v6-broadcast-frr: OSPFv3 DR/BDR elected, Network-LSA + Ze Link-LSA present, "
        "adjacency Full"
    )
