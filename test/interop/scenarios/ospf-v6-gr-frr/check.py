#!/usr/bin/env python3
"""Scenario ospf-v6-gr-frr: OSPFv3 Graceful Restart interop with FRR ospf6d (RFC 5187).
...
def check():
    ...
    log_pass("ospf-v6-gr-frr: OSPFv3 Grace-LSA (0x000B) interop + helper hold verified")
