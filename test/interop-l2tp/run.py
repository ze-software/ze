...
Usage:
    python3 test/interop-l2tp/run.py                          # run all scenarios
    python3 test/interop-l2tp/run.py 01-ppp-ipv4              # run specific scenario
    VERBOSE=1 python3 test/interop-l2tp/run.py                # verbose output
