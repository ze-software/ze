#!/bin/sh
# Scenario-local PKI for 25-responder-eap-tls13, where ZE is the EAP-TLS SERVER
...
# their own names.
#
# Unlike 06-eap-tls13 the CA is prime256v1 and not RSA. That RSA constraint is a
