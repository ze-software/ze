...
| Test | Reason |
|------|--------|
| TestEncodeRouteEmitsZeroValuedActions | Thomas approved on 2026-08-31. The scope put to him was the tagged units this keyword rename reaches, twenty-two requirement ids across RFC 5575, RFC 8955 and RFC 8956. What changes is the FlowSpec match keyword an operator types. `match destination 10.0.0.0/8` becomes `match destination-ipv4 10.0.0.0/8`. ze keeps only the four family-qualified prefix keywords ExaBGP emits, so the bare `destination` and `source` are gone. No expected byte, no polarity and no requirement id moves. A later reader can re-run the method: filter each diff for a changed line that is not the keyword. The only hit across every file is one added comment in types_test. It reads that the keyword names the family of the address the component holds. The requirement this test proves is untouched, and it still proves it. |
| TestEncodeRouteMarkKeepsReservedBitsZero | Thomas approved on 2026-08-31. The scope put to him was the tagged units this keyword rename reaches, twenty-two requirement ids across RFC 5575, RFC 8955 and RFC 8956. What changes is the FlowSpec match keyword an operator types. `match destination 10.0.0.0/8` becomes `match destination-ipv4 10.0.0.0/8`. ze keeps only the four family-qualified prefix keywords ExaBGP emits, so the bare `destination` and `source` are gone. No expected byte, no polarity and no requirement id moves. A later reader can re-run the method: filter each diff for a changed line that is not the keyword. The only hit across every file is one added comment in types_test. It reads that the keyword names the family of the address the component holds. The requirement this test proves is untouched, and it still proves it. |
| TestAddComponentRefusesASecondPrefix | Thomas approved on 2026-08-31. The scope put to him was the tagged units this keyword rename reaches, twenty-two requirement ids across RFC 5575, RFC 8955 and RFC 8956. What changes is the FlowSpec match keyword an operator types. `match destination 10.0.0.0/8` becomes `match destination-ipv4 10.0.0.0/8`. ze keeps only the four family-qualified prefix keywords ExaBGP emits, so the bare `destination` and `source` are gone. No expected byte, no polarity and no requirement id moves. A later reader can re-run the method: filter each diff for a changed line that is not the keyword. The only hit across every file is one added comment in types_test. It reads that the keyword names the family of the address the component holds. The requirement this test proves is untouched, and it still proves it. |
| TestRFC8955NextHopIgnoredForFlowSpec | Thomas approved on 2026-08-31. The scope put to him was the tagged units this keyword rename reaches, twenty-two requirement ids across RFC 5575, RFC 8955 and RFC 8956. What changes is the FlowSpec match keyword an operator types. `match destination 10.0.0.0/8` becomes `match destination-ipv4 10.0.0.0/8`. ze keeps only the four family-qualified prefix keywords ExaBGP emits, so the bare `destination` and `source` are gone. No expected byte, no polarity and no requirement id moves. A later reader can re-run the method: filter each diff for a changed line that is not the keyword. The only hit across every file is one added comment in types_test. It reads that the keyword names the family of the address the component holds. The requirement this test proves is untouched, and it still proves it. |
