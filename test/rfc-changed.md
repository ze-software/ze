...
| Test | Reason |
| ------ | ------ |
| TestAeadAloneInItsOwnProposalIsAccepted | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
| TestAeadMixInOneProposalIsRefused | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
| TestEsnInitiatorRefusesAnESNValueItNeverOffered | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
| TestKlnInitiatorRefusesLongerAcceptedKey | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
| TestNegInitiatorRejectsUnproposedOffer | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
| TestSesAcceptedProposalKeepsItsProtocol | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
| TestESPProposalsNeverMixAEADClass | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
| TestESPWireProposalAEADIntegNone | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
| TestLifetimesNotNegotiatedOnWire | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
| TestTftForeignTransformTypeRefusedInESPOffer | Thomas approved this on 2026-09-04, in answer to the change put to him: the IPsec PFS fix he ordered gives `buildWireESPProposals` a Diffie-Hellman parameter and `espProposalMatches` / `matchOfferedESPProposal` an `espDHMatch`, so every call site moves. This test's edit is that call-site update alone: it passes `dhGroupNone` and `espDHMatch{}`, which are the values that reproduce the previous behaviour exactly, so the test asserts what it asserted before and its tag still says what its body checks. He was given the list of all ten and the nature of the edit, and approved committing them as they stand. |
