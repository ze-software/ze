...
| Measure | Value | Count | What it means |
|---|---:|---|---|
| Gated MUSTs | 51 | of 94 this summary declares | MUST-level requirements the gate HOLDS. A population, not a result: the shares beside it are what says how Ze stands |
