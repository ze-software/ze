...
| Out of scope | 5 | of 9 gated MUSTs | an obligation that does not bind Ze. A {not-applicable} annotation says it never bound; a {feature-declined} annotation says its condition is an optional feature Ze does not offer, and quotes the RFC sentence that makes it optional. Scope, not coverage: it stays in the denominator every share on this page is taken over |
| Not applicable | 55.6% | 5 of 9 gated MUSTs | a {not-applicable} annotation says the obligation does not bind Ze, so no test is owed for it. It stays in the denominator every share here is taken over |
...
| `RFC7950-7.6.5-1` | If a mandatory node does not exist, server must reply with a missing-element error (Section 7.6.5) | MUST | 7.6.5 | **positive:** `unit/verify` [`TestValidator_MandatoryField`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L926). **negative:** `unit/verify` [`TestValidateTree_MandatoryMissing`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L330). **negative:** `unit/verify` [`TestValidator_MandatoryField`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L927) |
...
|---|---|---|---|
| negative | [`TestValidateTree_LengthViolation`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L409) | unit/verify | unproven |
| negative | [`TestValidateTree_PatternViolation`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L308) | unit/verify | unproven |
...
| negative | [`TestValidator_HoldTimeRange`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L892) | unit/verify | unproven |
| negative | [`TestValidator_ValidatePattern`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L843) | unit/verify | unproven |
| positive | [`TestValidator_HoldTimeRange`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L891) | unit/verify | unproven |
| positive | [`TestValidator_ValidatePattern`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L842) | unit/verify | unproven |
...
| negative | [`TestValidateTree_AddPathDirectionEnum`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L611) | unit/verify | unproven |
| negative | [`TestValidateTree_FamilyModeEnum`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L545) | unit/verify | unproven |
...
| positive | [`TestValidateTree_AddPathDirectionEnum`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L610) | unit/verify | unproven |
| positive | [`TestValidateTree_FamilyModeEnum`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L544) | unit/verify | unproven |
...
| Polarity | Test | Kind and tier | Proof state |
|---|---|---|---|
| negative | [`TestValidateTree_UnionViolation`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L358) | unit/verify | unproven |
...
| Polarity | Test | Kind and tier | Proof state |
|---|---|---|---|
| negative | [`TestValidateTree_MandatoryMissing`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L330) | unit/verify | unproven |
| negative | [`TestValidator_MandatoryField`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L927) | unit/verify | unproven |
| positive | [`TestValidator_MandatoryField`](https://github.com/ze-software/ze/blob/main/internal/component/config/validator_yang_test.go#L926) | unit/verify | unproven |
