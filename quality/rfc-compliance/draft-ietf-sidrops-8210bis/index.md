...
|---|---:|---|---|
| Tested both ways | 0.0% | 0 of 7 binding obligations | a positive test proves Ze does what the requirement demands and a negative one proves it refuses what the requirement forbids |
...
| Measure | Value | Count | What it means |
|---|---:|---|---|
| No test at all | 85.7% | 6 of 7 binding obligations | no test carries the requirement id, whether or not a gap states why |
