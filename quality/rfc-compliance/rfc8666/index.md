...
|---|---:|---|---|
| Tested both ways | 67.7% | 21 of 31 gated MUSTs | a positive test proves Ze does what the requirement demands and a negative one proves it refuses what the requirement forbids |
...
| Measure | Value | Count | What it means |
|---|---:|---|---|
| No test at all | 9.7% | 3 of 31 gated MUSTs | no test carries the requirement id, whether or not a gap states why |
