...
```
rfc-requirements OK: 2966 gated MUST-level requirement(s) across 171 enrolled RFC(s); 3589 test tag(s) resolved.
```
...
| Test tags | `internal/, pkg/, test/` | 3,589 resolved tags |
