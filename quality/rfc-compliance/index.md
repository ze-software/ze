...
```
rfc-requirements OK: 2965 gated MUST-level requirement(s) across 171 enrolled RFC(s); 3545 test tag(s) resolved.
```
...
| Test tags | `internal/, pkg/, test/` | 3,545 resolved tags |
