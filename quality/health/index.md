...
**21985 test functions** (ok)

2976 Go test files, 78 fuzz targets, 134 benchmarks, 1576 .ci scenarios, 164 .et editor tests. Counts cover internal, cmd, pkg, scripts, test only: vendor/ and gokrazy/modcache/ are third-party module trees and are excluded.
