...
| Test files that expect a specific error | Q2 | **1097 / 3228** (attention) | Take the lowest-ranked subsystem and add malformed-input or fault-injection cases. |
...
**23685 test functions** (ok)

3228 Go test files, 78 fuzz targets, 129 benchmarks, 1722 .ci scenarios, 166 .et editor tests. Counts cover internal, cmd, pkg, scripts, test only: vendor/ and gokrazy/modcache/ are third-party module trees and are excluded.
