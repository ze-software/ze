...
// move audit.
//
// Plugin roots come from letools/pluginimports.PluginSearchRoots. This function
...
// letools/pluginimports.TestTheRootsAreTheGeneratorsOwnList's sibling here,
...
func EngineMisplacements(tree, module string, edges Edges) (map[string]string, error) {
	...
	if len(pluginDirs) == 0 {
		return nil, errors.New("letools/pluginimports: no plugin search root -- gate cannot run safely")
	}
