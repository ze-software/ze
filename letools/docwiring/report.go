...
// Output contains a delegated child's stdout, which this gate relays without
// inspection. Skipped distinguishes an unnecessary check from a clean executed
// check. Empty JSON fields cannot show that distinction.
