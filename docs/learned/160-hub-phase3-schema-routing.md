...
- Shared diff library (`internal/config/diff/`) for plugins to compute live→edit diffs — diff responsibility belongs to plugins, not hub. Hub serves raw config, plugins decide what changed.
