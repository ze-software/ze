...
- [MCP Overview](overview.md) -- tools, transport and configuration
- [MCP Architecture](../../architecture/mcp/overview.md) -- internals
- [MCP API Methods](../../architecture/api/commands.md#mcp-methods) -- the method table
