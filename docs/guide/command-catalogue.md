...
| L2TP tunnel / session | `show interfaces l2tpv3` | `show services l2tp tunnel` | `show l2tp tunnel` | - | - | | shipped | config+nl | `show l2tp tunnels/sessions`, `clear l2tp tunnel/session {id <id> \| all}` |
