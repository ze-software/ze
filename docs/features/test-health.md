...
| Logged known-failing tests | Q3 | **8** (attention) | Fix or delete the oldest entry; a permanently logged failure is a deleted test with extra steps. |
