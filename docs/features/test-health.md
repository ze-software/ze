...
**19896 test functions** (ok)

2574 Go test files, 72 fuzz targets, 121 benchmarks, 1444 .ci scenarios, 164 .et editor tests. Counts cover internal, cmd, pkg, scripts, test only: vendor/ and gokrazy/modcache/ are third-party module trees and are excluded.
