...
| Test files that expect a specific error | Q2 | **1494 / 4193** (attention) | Take the lowest-ranked subsystem and add malformed-input or fault-injection cases. |
...
**30245 test functions** (ok)

4193 Go test files, 83 fuzz targets, 133 benchmarks, 2032 .ci scenarios, 170 .et editor tests. Counts cover internal, cmd, pkg, test only: vendor/ and gokrazy/modcache/ are third-party module trees and are excluded.
