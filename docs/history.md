...
Ze remains pre-release. Capability and maturity claims are generated from current source and evidence where possible. Use the [feature inventory](https://ze-software.net/features/), [RFC status](features/rfc-status.md), [quality evidence](https://ze-software.net/quality/), and [roadmap](https://ze-software.net/roadmap/) for current decisions rather than treating this history as a readiness statement.
