...
- **RFC:** 8203, 9003
- **Files:** `internal/bgp/message/notification.go`
...
- **RFC:** 4271 Section 4
- **Files:** `internal/bgp/message/header.go`
...
- **Files:** `internal/bgp/message/keepalive.go`
...
- **RFC:** 6793 Section 6
- **Files:** `internal/bgp/attribute/as4.go`
...
- **RFC:** 9072
- **Files:** `internal/bgp/message/open.go`
...
- **RFC:** 7313
- **Files:** `internal/bgp/message/routerefresh.go`, `internal/bgp/capability/`
...
- **RFC:** 5492
- **Files:** `internal/bgp/capability/negotiated.go`
...
- **Files:** `internal/bgp/message/open.go`, `internal/config/`
...
- **Files:** `internal/bgp/attribute/aspath.go`
...
- **RFC:** 5701
- **Files:** `internal/bgp/attribute/community.go`
...
- **Files:** `internal/bgp/attribute/origin.go`
...
- **RFC:** 4760 Section 6
- **Files:** `internal/reactor/session.go`, `internal/config/bgp.go`
...
- **RFC:** 5549/8950
- **Files:** `internal/bgp/attribute/mpnlri.go`, `internal/bgp/capability/capability.go`
...
- **Files:** `internal/bgp/message/update.go`
...
- **Files:** `internal/bgp/attribute/mpnlri.go`
...
- **Files:** `internal/bgp/nlri/evpn.go`
...
- **RFC:** 8955 Section 8
- **Files:** `internal/bgp/nlri/flowspec.go`
...
- **RFC:** 4761
- **Files:** `internal/bgp/nlri/other.go`
...
- **Files:** `internal/bgp/nlri/bgpls.go`
