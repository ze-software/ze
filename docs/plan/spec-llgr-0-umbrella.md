...
7. **Complete spec** -- Fill audit tables, write learned summary to `docs/learned/`
...
| `docs/learned/350-gr-receiving-speaker.md` | GR receiving speaker implementation |
| `docs/learned/353-gr-plugin-arch.md` | GR plugin architecture |
| `docs/learned/378-gr-mechanism.md` | Per-route stale tracking |
...
- [ ] Write learned summary to `docs/learned/NNN-llgr-0-umbrella.md`
