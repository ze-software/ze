...
7. **Complete spec** -> Fill audit tables, write learned summary to `docs/learned/NNN-<name>.md`, delete spec from `docs/plan/`. BLOCKING: summary is part of the commit, not a follow-up.
