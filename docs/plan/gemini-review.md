...
*   **Memory Pools:** The "Pool + Wire" design (transition documented in `docs/architecture/rib-transition.md`) uses a double-buffered, incremental compaction strategy to deduplicate attributes and NLRIs, minimizing GC pressure.
...
The project is currently in the middle of a major architectural transition to the full "Pool + Wire" model (`docs/plan/CLAUDE_CONTINUATION.md`).
