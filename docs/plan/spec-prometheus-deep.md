...
3. `docs/learned/386-prometheus-metrics.md` - decisions from initial Prometheus work
4. `docs/learned/388-cli-metrics.md` - CLI metrics commands
5. `docs/learned/376-backpressure.md` - backpressure mechanism (has metrics gaps)
...
### Learned Summaries
- [ ] `docs/learned/386-prometheus-metrics.md` - initial Prometheus work decisions
...
- [ ] `docs/learned/388-cli-metrics.md` - CLI metrics access
  → Constraint: `bgp metrics show`/`list` work via dispatch-command, reads from same registry
- [ ] `docs/learned/376-backpressure.md` - backpressure mechanism
...
- [ ] Write learned summary to `docs/learned/NNN-prometheus-deep.md`
