...
| [Plugins](features/plugins.md) | RIB, route server, graceful restart, RPKI, community filters |
| [CLI Commands](features/cli-commands.md) | Protocol tools, config management, schema discovery, daemon control |
