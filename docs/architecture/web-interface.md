...
`./le repo generate` compiles each `.templ` into a `*_templ.go` beside it, and
...
| `*.templ` | The markup, compiled into `*_templ.go` by `./le repo generate` |
