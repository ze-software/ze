...
The IPv6 wire codec and raw transport stay in `internal/plugins/ospfv3/{types,packet,transport}`
...
<!-- source: internal/plugins/ospfv3/transport/backend_linux.go -- OpenInterface, setupSocket -->
...
<!-- source: internal/plugins/ospfv3/transport/backend_linux.go -- resolveOSPFv3Interface, interfaceLinkLocal -->
...
payload)` upward.
<!-- source: internal/plugins/ospfv3/transport/transport.go -- RawPacket, rxLoop -->
...
<!-- source: internal/plugins/ospfv3/transport/transport.go -- SendPacket -->
<!-- source: internal/plugins/ospfv3/packet/checksum.go -- FinalizePacketChecksum, PacketChecksum, VerifyPacketChecksum -->
...
<!-- source: internal/plugins/ospfv3/transport/transport.go -- rxLoop -->
<!-- source: internal/plugins/ospfv3/packet/header.go -- PeekInstanceID -->
...
<!-- source: internal/plugins/ospfv3/transport/backend_linux.go -- joinLeave -->
...
<!-- source: internal/plugins/ospfv3/transport/backend_linux.go -- Send, deliver -->
