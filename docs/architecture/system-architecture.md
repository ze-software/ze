...
>   `group` blocks (see [deprecated config options](config/deprecated-options.md)
>   and [config syntax](config/syntax.md)).
...
>
> For the current architecture see [Core Design](core-design.md) (canonical) and
