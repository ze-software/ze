...
Summary 221, retired on 2026-08-01: the first round split 4 files (bgp.go, model.go + their tests). It validated the approach: all tests pass, auto-linter handles imports, no behavioral changes. The summary was not carried into `plan/learned/DESIGN-HISTORY.md`, whose header gives the git-recovery route.
