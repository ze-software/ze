...
## Validation
The `./le ai hooks validate-spec` action, produced by `internal/le/hookruntime/lifecycle.go`, BLOCKS specs containing code blocks. Fix: convert code to tables and prose before saving.
