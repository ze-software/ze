...
Third-party assets synced from `third_party/web/` (htmx.min.js v4.0.0, hx-sse.min.js, ze.svg)
via `internal/le/web/vendor/actions.go` (run `./le vendor-web sync`). Never write custom JS shims.
