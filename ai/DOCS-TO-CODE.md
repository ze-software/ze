...
| `internal/plugins/geodns/negative_rfc1035_test.go` | the answer policy's three response |
...
| `internal/core/dnsserver/header_rfc1035_test.go` | shapeAuthoritative owns the |
...
| `internal/component/bgp/plugins/rpki/blackhole.go` | RFC 6811 origin validation |
...
| File | Topic |
|------|-------|
| `internal/perf/allocgate.go` | alloc-ceiling gate (ze-alloc-check stage) |
