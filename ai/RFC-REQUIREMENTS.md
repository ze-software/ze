...
82 MUST-level requirement(s) still owe work across 172 summaries. **Outstanding** = has only one polarity, or has no test and no annotation; those are the tests that do not exist yet.
