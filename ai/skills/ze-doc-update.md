...
| `docs/performance.md` | Generated by `./le perf report --doc`. Only update if regenerated. |
...
14. **Regenerate `ai/CODE-TO-DOCS.md`:** Run `./le doc index write` to update the code-to-docs reverse index. If any docs/ source anchors were added, changed, or removed, this keeps the index in sync.
