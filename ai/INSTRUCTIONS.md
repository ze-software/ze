<!-- DO NOT EDIT THIS FILE. Edit ai/INSTRUCTIONS.md and run: make ze-ai-instructions-generate -->
...
- When the user asks for a commit, prepare the commit script and run it
  ...
  never rerun `make ze-precommit-verify` or `make ze-precommit-verify-changed`.
...
<!-- BEGIN GENERATED: arch-components (scripts/dev/arch_map.py; make ze-generated-files-update) -->
...
<!-- BEGIN GENERATED: arch-system-plugins (scripts/dev/arch_map.py; make ze-generated-files-update) -->
...
<!-- BEGIN GENERATED: arch-bgp-plugins (scripts/dev/arch_map.py; make ze-generated-files-update) -->
...
Both come from one parse by `make ze-rules-condensed-update`, in the canonical
