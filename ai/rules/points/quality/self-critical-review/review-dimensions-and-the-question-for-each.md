...
| Style | Every loop, queue, retry and cache bounded? Every name says what the value IS? Every lifecycle obligation in a comment? No `panic()` a peer can reach? (`docs/contributing/ze-style.md`) |
