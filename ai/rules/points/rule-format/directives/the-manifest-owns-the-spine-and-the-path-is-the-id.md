...
- **A body is verbatim.** The renderer concatenates bodies and rewrites nothing inside one, which is what makes `make ze-rules-points-roundtrip-check` a proof rather than a comparison.
