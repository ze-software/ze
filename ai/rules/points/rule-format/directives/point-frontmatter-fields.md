...
| `rationale` | a repo-relative path, or the line absent | The record of WHY this instruction exists: a `plan/learned/NNNN-*.md` summary, or an `ai/rationale/*.md` file. `make ze-rules-gate-map` fails when it names no file on disk |
