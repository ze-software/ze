...
| New doc or inventory checker | `docs/contributing/documentation-testing.md`, the quick reference of the owning `mk/check-*.mk` or `mk/report-inventory.mk`, and `ai/rules/writing.md` if policy changed |
