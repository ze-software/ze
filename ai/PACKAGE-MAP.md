...
|---------|----------------|------------|
| `cmd/le` | is the le command, the Ze repository and development entry point: one binary over the same command engine ze uses, carrying the development tools and none of the product's plugins |  |
...
| Package | Responsibility | Registered |
|---------|----------------|------------|
| `letools/lepath` | answers one question for every le tool: which checkout am I working in |  |
