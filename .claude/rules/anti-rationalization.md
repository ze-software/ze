...
**BLOCKING:** Pre-addressed excuses. The answer is always "no."
...
| "I'll write tests after" | You won't. Post-hoc tests validate implementation, not requirements |
| "TDD will slow me down" | Rework from bugs is slower |
| "Just a refactor" | Existing tests should pass. If none exist, write them first |
...
No performative agreement ("You're absolutely right!"). Fix it, describe what changed, move on.
