...
| "Pre-existing issue" | Fix it. If it needs more than 10 minutes, log to `plan/known-failures.md` and continue |
...
`plan/known-failures.md` with the failure output and root-cause hypothesis so the next session
