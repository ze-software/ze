...
**Verification:** `go test -race -count=5 ./internal/component/bgp/reactor/...` → ok (16.4s). `go test -race -count=5 ./internal/chaos/inprocess/... ./internal/component/bgp/reactor/...` → ok. No behavioral change; locking discipline only.
