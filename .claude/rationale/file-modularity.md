...
`docs/plan/done/221-file-splitting.md` — first round split 4 files (bgp.go, model.go + their tests). Validated the approach: all tests pass, auto-linter handles imports, no behavioral changes.
