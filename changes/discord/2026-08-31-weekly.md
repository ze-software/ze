...
New:
- The bridge is checked against ExaBGP's own tests. All 40 of the upstream `qa/api` scripts run against Ze now, alongside 42 encoding cases, rather than a hand-picked subset.
...
Of 5,441 requirements, 3,578 are MUST-level and 3,302 are checked. That is 326 more MUSTs checked than last week. 313 still owe a test, against 68 last week, and 57 of the 182 documents have been read end to end, against 6.

The owing number rose because a document read end to end writes down every obligation in it, including the ones nothing tests yet. The list gained 507 MUSTs this week, faster than the fixing closed them.
