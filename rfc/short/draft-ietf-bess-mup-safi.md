...
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.1-1] [MUST] PE advertising ISD route must attach export BGP Route Target Extended Community of the associated routing instance (Section 3.3.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.1-2] [MUST] PE advertising ISD route must use IPv6 address of PE as nexthop in MP_REACH_NLRI (Section 3.3.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.1-3] [MUST] ISD route update must have a prefix SID attribute (Section 3.3.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.2-1] [MUST] PE withdrawing ISD route must attach export BGP Route Target Extended Community (Section 3.3.2)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.4-1] [MUST] DSD address in NLRI must be a unique PE identifier (Section 3.3.4)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.4-2] [MUST] PE announcing DSD route must attach a BGP MUP Extended Community (Section 3.3.4)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.4-3] [MUST] PE advertising DSD route must use IPv6 address of PE as nexthop in MP_REACH_NLRI (Section 3.3.4)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.4-4] [MUST] DSD route update must have a prefix SID attribute (Section 3.3.4)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.5-1] [MUST] BGP speaker announcing T1ST must attach a BGP MUP Extended Community (Section 3.3.5)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.7-1] [MUST] MUP Controller must set nexthop of T1ST route to the controller address (Section 3.3.7)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.7-2] [MUST] Controller must announce T1ST route using AFI of the route and SAFI BGP-MUP to all BGP speakers in SRv6 domain (Section 3.3.7)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.10-1] [MUST] Controller must attach Route Target Extended Community of routing instances in the PE for T2ST (Section 3.3.10)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.10-2] [MUST] Controller must set nexthop of T2ST route to MUP Controller address (Section 3.3.10)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1-1] [MUST] Unknown Route Types for supported Architecture Types must be silently ignored (Section 3.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.3-1] [MUST] Receiver must ensure ISD Address field value is address of originator of locator in prefix SID attribute (Section 3.3.3)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.3-2] [MUST] On MP_UNREACH_NLRI, receiver must delete withdrawn ISD route from routing instance table (Section 3.3.3)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.6-1] [MUST] Receiver must ensure DSD nexthop in MP_REACH_NLRI is identical to originator of locator in prefix SID attribute (Section 3.3.6)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.6-2] [MUST] On MP_UNREACH_NLRI, receiver must delete withdrawn DSD route from routing instance table (Section 3.3.6)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.9-1] [MUST] PE receiving T1ST routes in MP_UNREACH_NLRI must delete all routes from associated routing instance (Section 3.3.9)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.12-1] [MUST] PE must handle T2ST without MUP Extended Community as treat-as-withdraw (Section 3.3.12)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.1-1] [MUST] ISD with prefix length exceeding max for AFI: treat-as-withdraw per RFC 7606 (Section 3.1.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.1-2] [MUST] Speaker must skip malformed NLRIs and continue processing rest of Update message (Section 3.1.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.2-1] [MUST] DSD with wrong address size for AFI: treat-as-withdraw per RFC 7606 (Section 3.1.2)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.3-1] [MUST] T1ST with prefix length exceeding max for AFI: treat-as-withdraw per RFC 7606 (Section 3.1.3)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.3.1-1] [MUST] T1ST with TEID=0: treat-as-withdraw per RFC 7606 (Section 3.1.3.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.3.1-2] [MUST] T1ST with invalid Endpoint Address Length (not 32 or 128): treat-as-withdraw (Section 3.1.3.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.3.1-3] [MUST] T1ST with invalid Source Address Length (not 0, 32, or 128): treat-as-withdraw (Section 3.1.3.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.4-1] [MUST] T2ST with Endpoint Length exceeding max for AFI: treat-as-withdraw (Section 3.1.4)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.4.1-1] [MUST] T2ST with TEID=0: treat-as-withdraw per RFC 7606 (Section 3.1.4.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.3.1-4] [MUST] T1ST NLRI architecture field MUST be encoded as specified for 3gpp-5g; otherwise treat-as-withdraw (Section 3.1.3.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.1.4.1-2] [MUST] T2ST NLRI architecture field MUST be encoded as specified for 3gpp-5g; otherwise treat-as-withdraw (Section 3.1.4.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.3-3] [MUST] ISD/DSD without prefix SID attribute: treat-as-withdraw (Section 3.3.3, 3.3.6)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.3-4] [MUST] Nexthop/locator mismatch on ISD/DSD: treat-as-withdraw (Section 3.3.3, 3.3.6)
...
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.1-4] [MUST] ISD prefix SID function MUST be GTP4.E if BGP AFI is IPv4, or MUST be GTP6.E if BGP AFI is IPv6 (Section 3.3.1)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.5-2] [MUST] When withdrawing DSD route, BGP speaker MUST attach a BGP MUP Extended community of the associated routing instance (Section 3.3.5)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.8-1] [MUST] Controller MUST advertise the withdrawal of the Type 1 ST route (Section 3.3.8)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.7-3] [MUST] Controller MUST advertise the Type 1 ST route with Destination prefix, TEID, QFI, Endpoint Address, and optionally Source Address (Section 3.3.7)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.9-2] [MUST] PE receiving T1ST in MP_UNREACH_NLRI without Source address MUST delete all matching T1ST routes with different Source addresses (Section 3.3.9)
- [ ] [DRAFT-IETF-BESS-MUP-SAFI-3.3.11-1] [MUST] Controller MUST advertise the withdrawal of the Type 2 ST route (Section 3.3.11)
